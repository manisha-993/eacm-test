...
public class R151create012ClassificationForMC extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R151create012ClassificationForMC(String type, CHWAnnouncement chwA,
		...
		r0Row.setKparaValu("MK_" + type + "_MC");
		...
		r6Row.setValue("MODEL CONVERSION");
