...
public class R185deleteupgradevaluefromMCcharacteristic extends Rfc {
	private com.ibm.rdh.rfc.Z_DM_SAP_CHAR_MAINTAIN rfc;

	public R185deleteupgradevaluefromMCcharacteristic(
		...
		c4Row.setValue(typeModel.getFromModel() + "_" + typeModel.getModel());
		c4Row.setFldelete("X");
	...
	protected String getMaterialName() {
		return "Delete Upgrade Value from MC characteristic";
	}
