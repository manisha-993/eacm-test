...
public class R156createZDMClassificationForTypeModel extends Rfc {
	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R156createZDMClassificationForTypeModel(String typemod, String div,
			CHWAnnouncement chwA, String pimsIdentity, boolean seoFlag)
			throws Exception {
		reInitialize();
	...
	protected String getMaterialName() {
		return "Create ZDM Classification for type model";
	}
