...
public class R137create300ClassificationForTypeUFForMTC extends Rfc {
	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R137create300ClassificationForTypeUFForMTC(TypeModelUPGGeo tmUPGObj,
			String range, CHWAnnouncement chwA, String newFlag,
		...
		if ("MTC".equals(newFlag) && "MTCTOTYPE".equals(FromToType)) {
			r2Row.setClass("MK_" + tmUPGObj.getType() + "_UF_" + range);
		} else if ("MTC".equals(newFlag) && "MTCFROMTYPE".equals(FromToType)) {
			r2Row.setClass("MK_" + tmUPGObj.getFromType() + "_UF_" + range);
		}
	...
	protected String getMaterialName() {
		// TODO Auto-generated method stub
		return "Create 300 Classification for type UF for UPG";
	}
