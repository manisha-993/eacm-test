...
public class R148_createConfigurationProfileForNewMaterial extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_CONP_MAINTAIN rfc;

	public R148_createConfigurationProfileForNewMaterial(String typeStr,
		...
		p0Row.setKparaValu(typeStr + "NEW");
	...
	protected String getMaterialName() {
		return "Create Configuration Profile for NEW material";
	}
