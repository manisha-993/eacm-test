...
public class R009Maintain001Classification extends Rfc {
	...
	public R009Maintain001Classification(TypeModel typeModel,
		...
		// r0Row.setKparaValu(typeModel.getMainProduct().getProductIdentifier());
		r0Row.setKparaValu(typeModel.getType());
		...
		// boolean isRevPart = typeModel.getId() != null
		// && typeModel.getId().startsWith("RP");
		r6Row.setCharact("MM_RPQTYPE");
		r6Row.setValue("RPQ APPROVE");
		// if (!isRevPart) {
		// String rpqType = _productSchedule.getMainProduct().getRpqType()
		// .getKwValue();
		// if (rpqType.equals(RpqType.APPROVAL_REQUIRED_RPQ.name())) {
		// charact1 = "MM_RPQTYPE";
		// value1 = "RPQ APPROVE";
		// }
		// if (rpqType.equals(RpqType.STANDARD_RPQ.name())) {
		// charact1 = "MM_RPQTYPE";
		// value1 = "RPQ OTHER";
		// }
		// if (rpqType.equals(RpqType.NOT_RPQ.name())) {
		// charact1 = "MM_RPQTYPE";
		// value1 = "RPQ OTHER";
		// }
		//
		// boolean isRevBomTemplFollowed = _productSchedule.getMainProduct()
		// .getIsRevBomTemplateFollowed();
		// List<RevenueComponent> cswRevComponents = _productSchedule
		// .getMainProduct().getCswRevComponents();
		// charact2 = "MM_BTPRODUCTS";
		// if (isRevBomTemplFollowed) {
		// value2 = "PROCESS1";
		// } else if (isNotEmpty(cswRevComponents)
		// && cswRevComponents.size() >= 1) {
		// value2 = "PROCESS3";
		// } else {
		// value2 = "";
		// }
		...
		//
		// int amortStart =
		// _productSchedule.getMainProduct().getSapAmortStart();
		// int amortLength =
		// _productSchedule.getMainProduct().getSapAmortLength();
		// charact3 = "MM_AMORTSTART";
		// value3 = "" + amortStart;
		// charact4 = "MM_AMORTLENGTH";
		// value4 = "" + amortLength;
		//
		// if (!isRevPart) {
		// boolean isRoyaltyBearing = _productSchedule.getMainProduct()
		// .getIsRoyaltyBearing();
		// charact5 = "MM_ROYALTY_BEAR_IND";
		// if (isRoyaltyBearing) {
		// value5 = "YES";
		// } else {
		// value5 = "NO";
