...
import com.ibm.rdh.rfc.Z_DM_SAP_ASSIGN_CHAR_TO_CLASS;
import com.ibm.rdh.rfc.Zdm_geo_to_classTable;
import com.ibm.rdh.rfc.Zdm_geo_to_classTableRow;

public class R110assignMODCharacteristicToModelsClass extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_ASSIGN_CHAR_TO_CLASS rfc;

	public R110assignMODCharacteristicToModelsClass(TypeModel typeModel,
		...
		// C0
		rfc.setJClass("MK_" + typeModel.getType() + "_MODELS");
		rfc.setJKlart("300");
	...
	protected String getMaterialName() {
		return "Assign MOD characteristic to MODELS class";
	}
