...
public class R207ReadPlantViewMaterial extends Rfc {
	...
	public R207ReadPlantViewMaterial(String type, String plant)
			throws Exception {
		reInitialize();
		...
		r0Row.setMatnr(type + "NEW");
		r0Row.setPlant(plant);
		r0Table.appendRow(r0Row);
		rfc.setZdmMatTab(r0Table);

		rfcInfo.append("ZDM_MAT_TAB Table \n");
		rfcInfo.append(Tab + "MATNR>>" + r0Row.getMatnr() + ", PLANT>>"
				+ r0Row.getPlant() + "\n");

		r0Row.setMatnr(type + "UPG");
		r0Row.setPlant(plant);
		r0Table.appendRow(r0Row);
		rfc.setZdmMatTab(r0Table);
