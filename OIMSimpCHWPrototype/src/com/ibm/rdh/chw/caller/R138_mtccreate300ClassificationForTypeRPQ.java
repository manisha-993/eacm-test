...
public class R138_mtccreate300ClassificationForTypeRPQ extends Rfc {
	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R138_mtccreate300ClassificationForTypeRPQ(TypeModelUPGGeo tmUPGObj,
		...
		if (newFlag.equals("MTC") && FromToType.equals("MTCTOTYPE")) {
		...
		if (FromToType.equals("MTCTOTYPE")) {
			r2Row.setClass("MK_" + tmUPGObj.getType() + "_RPQ");
		} else if (FromToType.equals("MTCFROMTYPE")) {
			r2Row.setClass("MK_" + tmUPGObj.getFromType() + "_RPQ");
		}
