...
public class R149_createConfigurationProfileForUPGMaterial extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_CONP_MAINTAIN rfc;

	public R149_createConfigurationProfileForUPGMaterial(String typeStr,
		...
		p0Row.setKparaValu(typeStr + "UPG");
	...
	protected String getMaterialName() {
		return "Create Configuration Profile for UPG material";
	}
