...
public class R128assignRPQTypeFeatureCharacteristicToTypeClass extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_ASSIGN_CHAR_TO_CLASS rfc;

	public R128assignRPQTypeFeatureCharacteristicToTypeClass(
		...
		c1Row.setMerkma("MK_" + typeFeature.getType() + "_"
