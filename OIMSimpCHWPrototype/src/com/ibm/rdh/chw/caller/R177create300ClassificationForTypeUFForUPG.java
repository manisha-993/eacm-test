...
public class R177create300ClassificationForTypeUFForUPG extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R177create300ClassificationForTypeUFForUPG(String type,
		...
		r2Row.setClass("MK_" + type + "_UF_" + range);
