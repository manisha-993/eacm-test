...
public class R152create012ClassificationForRPQTypeFeature extends Rfc {

	private com.ibm.rdh.rfc.Z_DM_SAP_CLASSIFICATION_MAINT rfc;

	public R152create012ClassificationForRPQTypeFeature(
		...
		r6Row.setValue("FEATURE");

		r6Row = r6Table.createEmptyRow();
		r6Vector.addElement(r6Row);
		r6Row.setCharact("MK_CHARACTERISTIC_TYPE");

		if (typeFeature.getApprovalRPQ()) {
			r6Row.setValue("RPQ APPROVE");
		} else {
			r6Row.setValue("RPQ OTHER");
		}

		if (!typeFeature.getNoChargePurchase()) {
			r6Row = r6Table.createEmptyRow();
			r6Vector.addElement(r6Row);
		...
		if (typeFeature.getItemReturned()) {
			r6Row = r6Table.createEmptyRow();
			r6Vector.addElement(r6Row);
			r6Row.setCharact("MK_SALES_RELEVANCY");
			r6Row.setValue("RETURNS");
		}
		...
		if (typeFeature.getNoChargePurchase()) {
			...
			r6Vector.addElement(r6Row);
			r6Row.setCharact("MK_SALES_RELEVANCY");
			r6Row.setValue("NO CHARGE");
		}

		if (typeFeature.getRemovalCharge()) {
			r6Row = r6Table.createEmptyRow();
			r6Vector.addElement(r6Row);
			r6Row.setCharact("MK_SALES_RELEVANCY");
	...
	protected String getMaterialName() {
		return "Create 012 Classification for RPQ TypeFeature";
	}
