 ...
 * Creation date: (4/19/2001 11:46:38 AM)
...
/*****
	...
	If TypeFeature.FeatureID = 'Q' then
  Range = 'RPQ'
Else if TypeFeature.Feature first character is alphabetic (not numeric) then
  Range = ""
Else 
  Range = first 2 characters of TypeFeature.Feature + '00'
  (Example if Feature = 1234, range = 1200)
End if
******/
 ...
 * Creation date: (4/30/2001 4:18:18 PM)
 * @param type java.lang.String
 * @param feature java.lang.String
 */
//public TypeFeature(String go, String typ, String feat, String anndocno,boolean mmlcPromoteSelect) throws HWPIMSAbnormalException{
//	
//    if(!mmlcPromoteSelect)
//    {
//	setTfgCollection(new TypeFeatureGeoCollection(go, typ, feat, anndocno,mmlcPromoteSelect));
//    }
//    else
//    {
//        setTfgCollection(new TypeFeatureGeoCollection(go, typ, feat, anndocno,mmlcPromoteSelect));
...
//}
	 ...
	 * 
	 * @param rs - the result set positioned to the proper row.
	 */
...
//	}
	 ...
	 */
//	public static TypeFeature getObject(String type, String feature, boolean retrieveCollection)
//		throws HWPIMSAbnormalException
//	{
...
//RCQ00055238 changes - Ashutosh, Saurabh start
/**
 * checks whether the Feature Code contains any alphanumeric character or not 
 ...
 * @throws HWPIMSAbnormalException
 */
//private String calculateAlphanumericFeatureRange() throws HWPIMSAbnormalException{
//	String range = "";
//	int recordCount = 0;	
//	
...
//			sql = "SELECT type,range,count(*) as rangeCount FROM " + schema + ".TYPE_FEAT_RANGE_LINK"
...
//					}else{						
//						range = range.substring(0,1) + getFOrmattedRange(Integer.toString(Integer.parseInt(range.substring(1,4)) + 1));;
//					}
//			}
//			
//			sql = "INSERT INTO " + schema + ".TYPE_FEAT_RANGE_LINK"
//			+ "(TYPE, FEATURE, RANGE) VALUES('" + type + "', '" + feature + "', '" + range + "')";
//			
//			
...
//	catch (SQLException e)
//	{
//		String msg = "Unable to create Type Fature from Db entry via SQL: " + sql;
//		HWPIMSLog.Write(msg + "\n" + ExceptionUtility.getStackTrace(e),"E");
//		throw new HWPIMSAbnormalException(msg, e);
//	}
//	finally
...
/**
 * Insert the method's description here.
 * Creation date: (5/2/2001 11:29:29 AM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:07:40 PM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (5/30/2001 9:38:09 AM)
 * @return boolean
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:11:01 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/19/2001 11:47:56 AM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:56:52 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/19/2001 11:47:37 AM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/19/2001 11:49:16 AM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:58:49 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:58:33 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:16:24 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:09:48 PM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:17:57 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:17:29 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:16:57 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:12:33 PM)
 * @return java.lang.String
 */

//RQ5437 - Remove attribute perCallClass

/*public java.lang.String getPerCallClass() {
	return perCallClass;
}*/

/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:57:52 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (5/30/2001 9:37:36 AM)
 * @return boolean
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:15:17 PM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:57:25 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:18:27 PM)
 * @return int
 */
...
/**
 * Insert the method's description here.
 * Creation date: (4/30/2001 2:00:10 PM)
...
/**
 * Insert the method's description here.
 * Creation date: (4/19/2001 11:47:09 AM)
 * @return java.lang.String
 */
...
/**
 * Insert the method's description here.
 * Creation date: (5/23/2001 5:50:40 PM)
 * @return boolean
 */
...
/**
 * Insert the method's description here.
 * Creation date: (5/30/2001 11:58:59 AM)
 * @return java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (4/19/2001 11:49:16 AM)
 * @param newFeatureID java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:09:48 PM)
 * @param newModificationReason java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:12:33 PM)
 * @param newPerCallClass java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (5/30/2001 9:37:36 AM)
 * @param newRemovalCharge boolean
 */
 ...
 * Insert the method's description here.
 * Creation date: (4/26/2001 2:15:17 PM)
 * @param newSpecFeatType java.lang.String
 */
 ...
 * Insert the method's description here.
 * Creation date: (4/30/2001 2:00:10 PM)
 * @param newTfgCollection com.ibm.pprds.epimshw.TypeFeatureGeoCollection
 */
//public void setTfgCollection(TypeFeatureGeoCollection newTfgCollection) {
//	tfgCollection = newTfgCollection;
//}
//
//public void setTfsoCollection(TypeFeatureSalesOrgCollection newTfgsoCoolection){
 ...
 * Insert the method's description here.
 * Creation date: (5/30/2001 11:58:59 AM)
 * @param newWarrantyPer java.lang.String
 */
...
//	public boolean getAnyGeoNew( Vector tfGeos) throws HWPIMSAbnormalException
//	{
...
//	}
//	
//		public boolean getAnyGeoChanged( Vector tfGeos) throws HWPIMSAbnormalException
//	{
...
//	}
//
//		public boolean getAnyGeoDeleted( Vector tfGeos) throws HWPIMSAbnormalException
//	{
...
//		public boolean getAllGeosDeleted( Vector tfGeos) throws HWPIMSAbnormalException
//	{
...
//	}
//
//		public boolean getAllGeosPromoted( Vector tfGeos) throws HWPIMSAbnormalException
//	{
