...
public class RfcFactory extends Object {
	...
	public R102createSalesViewforMaterial getr102(CHWAnnouncement chwA,
			...
			TypeModelUPGGeo tmUPGObj, String fromToType, String pimsIdentity,
			String flfilcd, String salesOrg, Vector taxCntryList) throws Exception {
		return new R102createSalesViewforMaterial(chwA, typeModel, sapPlant,  newFlag, tmUPGObj, fromToType, 
	...
	public R103create001ClassificationForMGCommon getr103(TypeModel typeModel,
		...
		return new R103create001ClassificationForMGCommon(typeModel, newFlag, chwA, tmUPGObj,
