...
public abstract class RfcProxy {
	...
	/* rjc - this class will instantiate the respective RFC and
	 * then NOT execute it. in some cases, bogus data will be created to 
	 *  test the promote. 
	 */
	
	public abstract void  r100(CHWAnnouncement chwA,
	...
	public abstract void  r101(CHWAnnouncement chwA,
			TypeModel typeModel, CHWGeoAnn chwAg, String newFlag,
...
//	public abstract void r004(SWO swo, AnnouncementGeo annGeo) throws Exception;
//	public abstract void r005(SWO swo, Announcement ann, String plant) throws Exception;
//	public abstract void r006(SWO swo, GeoCountry country, Announcement ann, PlannedSalesStatus pss) throws Exception ;
//	public abstract void r007(SWO swo, GeoCountry country, String actionCode, PlannedSalesStatus pss) throws Exception;
...
//	public abstract boolean r010(SWO swo, String classRange ) throws Exception;
//	public abstract void r011(SWO swo, Sw300 sw300) throws Exception;
//	public abstract void r012(SWO swo, Announcement ann, Sw300 sw300 ) throws Exception;
//	public abstract void r012(SWO swo, Announcement ann, Sw300 sw300, Sw300Characteristic swc ) throws Exception;
//	public abstract void r013(SWO swo, Announcement ann, Sw300 sw300 ) throws Exception;
//	public abstract void r013(SWO swo, Announcement ann, Sw300 sw300, Sw300Characteristic swc ) throws Exception;
//	public abstract void r014(SWO swo, Announcement ann, Sw300Characteristic swc ) throws Exception;
//	public abstract void r015(SWO swo, RegularEntitlementFeature feat) throws Exception;
//	public abstract void r016(SWO swo, UpgradeEntitlementFeature uef) throws Exception;
//	public abstract void r017(SWO swo, SupplyFeature sf) throws Exception;
//	public abstract void r018(SWO swo, ProcessOptionFeature pof) throws Exception;
//	public abstract void r019(SWO swo, RegistrationFeature rf) throws Exception;
//	public abstract void r020(SWO swo, Announcement ann, Collection deleteList) throws Exception;
//	public abstract boolean r021(SWO swo, String plant) throws Exception;
//	public abstract Vector r021DataFunction(SWO swo, int function, String plant) throws Exception ;	
//	public abstract void r022(SWO swo, String plant ) throws Exception;
//	public abstract void r023(SWO swo, Stpo_api02Table stpoTable, String plant) throws Exception;
...
//	public abstract Vector r025DataFunction(SWO swo, int function, String plant) throws Exception ;	
//	public abstract void r026(SWO swo, String plant ) throws Exception;
//	public abstract void r027(SWO swo, Stpo_api02Table stpoTable, String plant) throws Exception;
...
//	public abstract Vector r029DataFunction(SWO swo, int function, String plant) throws Exception ;	
//	public abstract void r030( SWO swo, String plant  ) throws Exception;
//	public abstract void r031(SWO swo, Stpo_api02Table stpoTable, String plant) throws Exception;
...
//	public abstract Vector r033DataFunction(SWO swo, String classNum, int function) throws Exception;
//	public abstract boolean r034(SWO swo, Sw300Characteristic swc, String classRange ) throws Exception;
//	public abstract boolean r034(SWO swo, String swc, String classRange ) throws Exception;
//	
...
//	public abstract Vector r041DataFunction(SWO swo, int function, String plant) throws Exception ;	
//	public abstract void r042(SWO swo, String plant) throws Exception ;
//	public abstract void r043(SWO swo, Stpo_api02Table stpoTable, String plant) throws Exception;
//	public abstract void r044(SWO swo, String plant) throws Exception;
//	public abstract void r045(String swoID, String scheuduleID) throws Exception;
//	public abstract void r046(SWO swo, Announcement ann, String plant) throws Exception;	
//
//	public abstract boolean r047(SWO swo, String plant) throws Exception ; 
//	public abstract Vector r047DataFunction(SWO swo, int function, String plant) throws Exception ;	
//	public abstract void r048(SWO swo, String plant) throws Exception ;
//	public abstract void r049(SWO swo, Stpo_api02Table stpoTable, String plant) throws Exception;
...
//	public abstract boolean r052(SWO swo, ProductLifecycleStatus pls) throws Exception;
//	public abstract Vector r052DataFunction(SWO swo, ProductLifecycleStatus pls, int function) throws Exception;
//	public abstract boolean r053(SWO swo, ProductLifecycleStatus pls) throws Exception;
//	public abstract boolean r054(SWO swo, ProductLifecycleStatus pls) throws Exception;
//	public abstract boolean r055(SWO swo, ProductLifecycleStatus pls) throws Exception;			
//	public abstract void r056(SWO swo, Vector ipCollection) throws Exception;	
//	public abstract void r057(SWO swo, Announcement ann, String plant) throws Exception;	
//	public abstract void r058(SWO swo, Announcement ann) throws Exception;	
//	public abstract void r059(SWO swo, GeoProfile profile, Announcement ann) throws Exception;	
//	public abstract ArrayList r060(SWO swo, Announcement ann, Collection plants) throws Exception;	
//	public abstract void r061(SWO swo, Announcement ann, String plant) throws Exception;	
