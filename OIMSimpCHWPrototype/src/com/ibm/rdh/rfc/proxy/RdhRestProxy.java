	...
	public LifecycleData r200(String material, String varCond, String annDocNo,
		...
		for (int i = 0; i < rowCount; i++) {
			...
			if (vmsta.equals(PREANNOUNCE)) {
				...
				Date validFrom = sdf.parse(tRow.getDatabString());
				Date validTo = sdf.parse(tRow.getDatbiString());
				lcd.setAnnounceValidFrom(validFrom);
				lcd.setAnnounceValidTo(validTo);

				lcd.getAnnounceDataList().add(new LifecycleAnnounceData(validFrom, validTo));
