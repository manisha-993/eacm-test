...
public class R136create300ClassificationForTypeFEATTest extends
		RdhRestProxyTest {
	...
	public void prepareData() {
		...
		String sql_klah_1 = "insert into SAPR3.KLAH (mandt, klart, class,clint) values ('200', '300', 'MK_EACMT1_FEAT_F','1000000000')";
		String sql_klah_2 = "insert into SAPR3.KLAH (mandt, klart, class,clint) values ('200', '300', 'MK_EACMF1_FEAT_F','1000000001')";
	...
	public void r136MtcToType() {
		...
		try {
			...
			rfcProxy.r136(tmUPGObj, range, chwA, newFlag, FromToType,
					pimsIdentity);
	...
	public void deleteData() {
		String del_klah_1 = "delete from SAPR3.KLAH where mandt='200' and KLART='300' and CLASS='MK_EACMT1_FEAT_F' and clint='1000000000'";
		String del_klah_2 = "delete from SAPR3.KLAH where mandt='200' and KLART='300' and CLASS='MK_EACMF1_FEAT_F' and clint='1000000001'";
