...
public class R149_createConfigurationProfileForUPGMaterialTest extends RdhRestProxyTest{
	...
	public void prepareData() {
		...
		String del_cuco = "delete from sapr3.cuco where mandt='200' and obtab='MARA' and objek='EACMUPG'";
	...
	public void testR149() {
		try {
			...
			deletezdmLogHdrAndzdmLogDtl(Constants.MANDT,
					"Z_DM_SAP_CONP_MAINTAIN", typeStr + "UPG");

			RdhRestProxy rfcProxy = new RdhRestProxy();
			rfcProxy.r149(typeStr, chwA, pimsIdentity);
