...
public class R212DeleteSalesBOMfortypeMTCTest extends RdhRestProxyTest {
	...
	public void testR21201() {
		try {
			...
			dd.setItem_Count(new BigInteger("00000001"));
			componentstoDeleteTypeMTC.add(dd);
			String newFlag = "NEW";
			...
			rfcProxy.r212(type, sapPlant, componentstoDeleteTypeMTC, newFlag,
					chwA, pimsIdentity);
