...
public class R195DeleteRevenueProfileTest extends RdhRestProxyTest{
	...
	@Test
	public void testR19501() {
		try {
			logger.info("newFlag:NEW");
			String type="EACM";
			String annDocNo="123401";
			Vector revData=new Vector();
			RevData rev=new RevData("195A", "01", "EA", "57", null, null);
			Vector typeModelRevs=new Vector();
			String revProfileName="R195";
			String newFlag="NEW";
			...
			rfcProxy.r195(type, annDocNo, revData, typeModelRevs, revProfileName, newFlag, pimsIdentity, _plant);
