...
public class R134assignRPQTypeFeatureCharacteristicToTypeClassTest extends RdhRestProxyTest {
	...
	public void testR134(){
		try {
			...
			String j_class = "MK_" + typeFeature.getType() + "_FEAT_RPQ";
			deletezdmLogHdrAndzdmLogDtl(Constants.MANDT,
					"Z_DM_SAP_ASSIGN_CHAR_TO_CLASS", "300/" + j_class);

			RdhRestProxy rfcProxy = new RdhRestProxy();
			rfcProxy.r134(typeFeature, chwA, pimsIdentity);
