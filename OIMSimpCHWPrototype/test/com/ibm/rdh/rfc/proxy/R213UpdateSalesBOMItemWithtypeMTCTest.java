...
public class R213UpdateSalesBOMItemWithtypeMTCTest extends RdhRestProxyTest{
	...
	public void testR21301() {
		try {
			...
			rfcProxy.r213(type, sapPlant, geoV, newFlag, chwA, pimsIdentity);
	...
	public void testR21303() {
		try {
			...
			dd1.setItem_Categ("L");
			dd1.setItem_No("01");
			dd1.setItem_Node(new BigInteger("00000001"));
			geoV.add(dd1);
			String newFlag = "MTC";
			CHWAnnouncement chwA = new CHWAnnouncement();
			chwA.setAnnDocNo("123401");
