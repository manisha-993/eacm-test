...
public class R151create012ClassificationForMCTest extends RdhRestProxyTest {
	...
	public void deleteData() {
		...
		String del_cabn_1 = "delete from SAPR3.CABN where mandt='200' AND ATNAM='MK_SALES_RELEVANCY'";
		String del_cabn_2 = "delete from SAPR3.CABN where mandt='200' AND ATNAM='MK_CHARACTERISTIC_TYPE'";
