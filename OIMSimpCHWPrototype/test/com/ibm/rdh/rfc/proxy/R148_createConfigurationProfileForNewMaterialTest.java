...
public class R148_createConfigurationProfileForNewMaterialTest extends RdhRestProxyTest{
	...
	public void prepareData() {
		...
		String del_cuco = "delete from sapr3.cuco where mandt='200' and obtab='MARA' and objek='EACMNEW'";
	...
	public void testR148() {
		try {
			...
			deletezdmLogHdrAndzdmLogDtl(Constants.MANDT,
					"Z_DM_SAP_CONP_MAINTAIN", typeStr + "NEW");

			RdhRestProxy rfcProxy = new RdhRestProxy();
			rfcProxy.r148(typeStr, chwA, pimsIdentity);
