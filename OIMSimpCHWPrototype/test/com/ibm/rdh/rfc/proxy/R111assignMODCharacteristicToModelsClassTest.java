...
public class R111assignMODCharacteristicToModelsClassTest extends
	...
	public void prepareData() {
		String sql_cabn = "insert into SAPR3.CABN(MANDT,ATINN,ATNAM,ADZHL) values('200','0000000003','MK_EACF_MC','0000')";
		String sql_klah = "insert into SAPR3.KLAH (MANDT,CLINT,KLART,CLASS) values('200','0000000003','300','MK_EACF_MC')";
...
//			deleteKSMLRow("300", j_class, Constants.MANDT);
	...
	public void deleteData() {
		String del_cabn = "delete from SAPR3.CABN where MANDT='200' and ATINN='0000000003' AND ATNAM ='MK_EACF_MC' and ADZHL='0000'";
