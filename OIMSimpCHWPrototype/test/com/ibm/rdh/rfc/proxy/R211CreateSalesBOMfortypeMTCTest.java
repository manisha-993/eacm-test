...
public class R211CreateSalesBOMfortypeMTCTest extends RdhRestProxyTest {
	...
	public void prepareData() {
		...
		int t3 = SqlHelper.runUpdateSql(sql_marc_3, conn);
		int t4 = SqlHelper.runUpdateSql(sql_mara_1, conn);
		int t5 = SqlHelper.runUpdateSql(sql_mara_3, conn);
	...
	public void deleteData() {
		...
		String del_marc = "delete from sapr3.marc where mandt='200' and matnr in ('EACMNEW','EACMMTC') and werks='0011'";
		String del_mast = "delete from sapr3.mast where mandt='200' and matnr in ('EACMNEW','EACMMTC') and werks='0011' and stlan='5'";
		String del_mara = "delete from sapr3.mara where mandt='200' and MATNR in ('EACMNEW','EACMMTC')";
