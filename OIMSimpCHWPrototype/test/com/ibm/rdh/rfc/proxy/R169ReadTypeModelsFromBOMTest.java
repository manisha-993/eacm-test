...
public class R169ReadTypeModelsFromBOMTest extends RdhRestProxyTest {
	...
	public void prepareData() {
		String sql_mast = "insert into sapr3.mast(mandt,matnr,werks,stlan,stlnr,stlal) values ('200','EACMNEW','1222','5','10000001','10')";
	...
	public void deleteData() {
		String delete_mast = "delete from sapr3.mast where mandt='200' and matnr='EACMNEW' and werks='1222' and stlan='5' and stlnr='10000001' and stlal='10'";
