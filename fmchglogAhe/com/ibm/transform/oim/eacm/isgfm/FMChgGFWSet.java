...
class FMChgGFWSet extends FMChgSet
{
    ...
    */
    FMChgGFWSet(EntityItem fitem, EntityItem citem,
...
//      return featureCode+annDate+effDate+fm+name+wdcmt;
    ...
    */
    ...
    {
        super.calculateOutput(dbCurrent,profile,logGen);
        if (!hasWDdates && (!getChgType().equals(FMChgLogGen.NOCHG))) // MN24140028
        {
            logGen.trace(D.EBUG_DETAIL,false,"FMChgGFWSet.calculateOutput() "+getCurItem().getKey()+
