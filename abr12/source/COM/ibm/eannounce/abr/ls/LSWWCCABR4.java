 ...
 *
 * This ABR does the clean-up required when a course is retired.
 *
 *
 * Change History (most recent at top)
 * $Log: LSWWCCABR4.java,v $
 ...
 *
 * Revision 1.18  2006/03/13 19:05:46  couto
 * Fixed copyright info.
 *
 * Revision 1.17  2006/03/08 12:49:36  couto
 * Changed layout, using EACustom methods.
 * Fixed br tags. Chaged font tags.
 *
 * Revision 1.16  2006/01/26 00:36:19  joan
 * Jtest
 *
 * Revision 1.15  2006/01/22 18:28:30  joan
 * changes for Jtest
 *
 ...
 *
 * Revision 1.2  2003/10/23 19:24:00  cstolpe
 ...
 */
public class LSWWCCABR4 extends PokBaseABR {
    ...
    public void execute_run() {
        try {
            ...
            //    println("<br />LSWWCCABR4 not processed.  Current Lifecycle Status is not appropriate for this action.<br />");
            //    setReturnCode(FAIL);
            //}
            //else {
            sb = new StringBuffer();
            ...
            setReturnCode(PASS);
            triggerWorkFlow("WFLSWWCCRTNANOW");
            //}
    ...
    /**
     *  Gets the description attribute of the LSWWCCABR4 object
     *
