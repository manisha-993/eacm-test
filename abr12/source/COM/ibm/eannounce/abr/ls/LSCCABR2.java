 ...
 *
 * Revision 1.25  2006/03/13 19:05:44  couto
 * Fixed copyright info.
 *
 * Revision 1.24  2006/03/02 14:37:05  couto
 * Changed layout, using EACustom methods.
 * Fixed br tags. Chaged font tags. Fixed multiple return statements.
 *
 * Revision 1.23  2006/01/22 18:28:29  joan
 * changes for Jtest
 *
 * Revision 1.22  2006/01/21 18:13:17  joan
 * Jtest
 *
 * Revision 1.21  2005/01/26 23:23:45  joan
 * changes for Jtest
 *
 ...
 */
public class LSCCABR2 extends PokBaseABR {
    ...
    public void execute_run() {
        try {
            ...
            if (strPricing.equals("0030") && (strCAEdit.equals("0010") || strCAEdit.equals("0020") || strCAEdit.equals("0050"))) {
                ...
                if (!("0020".equals(strCAEdit) || "0050".equals(strCAEdit))) {
                    printErrorMessage(
                        "Catalog Editing approval required before Course Lifecycle status is set to Available. <!-- LSCCCATEDITSTATUS=%1# -->",
                        new String[]{
                            getAttributeMetaFlagDescription(getRootEntityType(),"LSCCCATEDITSTATUS", strCAEdit)
                        });
                    println("<br />");
                }
            }
    ...
    public String getDescription() {
        return "Sets Lifecycle Status to Available based on Catalog Editing and Pricing Status. Run when Pricing is approved";
    }
