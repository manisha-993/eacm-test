 ...
 *
 * Verify Worldwide Course can be retired.
 *
 * LS ABR14 to validate LSWW (Worldwide Course) retirement
 *
 ...
 */
public class LSWWABR14 extends PokBaseABR {
    ...
    public void execute_run() {
        try {
            ...
            //  println("<br />LSWWABR14 not processed.  Current Lifecycle Status is not appropriate for this action.<br />");
            //  iResults = FAIL;
            //}
            //else {
    ...
    private boolean checkRetiredEntities() throws java.rmi.RemoteException, MiddlewareException, MiddlewareShutdownInProgressException, java.io.UnsupportedEncodingException {
        ...
        // any linked WW In-Country courses must have a life cycle of retired
        if (!anyRetiredChildren(getRootEntityType(),
                getRootEntityID(), "LSWWCC", "LSWWWWCC",
                "LSWWCCLIFECYCLE", XR_LSWWCCLIFECYCLE_Retired)) {
            bResult = false;
        }
        return bResult;
    }
    ...
    public String getDescription() {
        return "Verify Worldwide Course can be Retired.";
    }
    //BEGIN CR0118023918
    //END CR0118023918
