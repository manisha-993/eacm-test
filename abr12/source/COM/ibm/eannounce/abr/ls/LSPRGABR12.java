 ...
 *
 * Verify Program Entity can be retired.
 *
 * LS ABR12 to validate LSPRG (Program) retirement
 *
 ...
 *
 * Revision 1.17  2006/03/06 17:30:41  couto
 ...
 * EC drop
 *
 * Revision 1.6  2003/10/30 20:32:26  cstolpe
 * Changed setDGTitle
 *
 ...
 */
public class LSPRGABR12 extends PokBaseABR {
    ...
    public void execute_run() {
        try {
            ...
            //  println("<br />LSPRGABR12 not processed.  Current Lifecycle Status is not appropriate for this action.<br />");
            //  iResults = FAIL;
            //}
            //else {
    ...
    private boolean checkRetiredEntities() throws java.rmi.RemoteException, MiddlewareException, MiddlewareShutdownInProgressException, java.io.UnsupportedEncodingException {
        ...
        // any linked Curriculums must have a life cycle of retired
        if (!anyRetiredChildren(getRootEntityType(), getRootEntityID(),
                "LSCUR", "LSPRGCUR",
                "LSCURLIFECYCLE", XR_LSCURLIFECYCLE_Retired)) {
            bResult = false;
        }
    ...
    public String getDescription() {
        return "Verify Program Entity can be Retired.";
    }
