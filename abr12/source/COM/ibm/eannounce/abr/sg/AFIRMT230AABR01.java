...
//
//AFIRMT230AABR01.java,v
//Revision 1.4  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.3  2006/01/24 17:05:07  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT230AABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT230AABR01");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT230AABR01 generating data");
        pdg =
          new HWPRODBASE30APDG(
            null,
            m_db,
            m_prof,
            "HWPRODBASE30APDG");
        ...
        log("AFIRMT230AABR01 finish generating data");
      }
  ...
  */
  ...
  public static String getVersion() {
    return ("AFIRMT230AABR01.java,v 1.4 2006/03/03 19:23:25 bala Exp");
  }
