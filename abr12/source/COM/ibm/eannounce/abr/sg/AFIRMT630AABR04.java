...
//
//AFIRMT630AABR04.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 17:06:46  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT630AABR04 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT630AABR04");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT630AABR04 generating data");
        pdg =
          new SWSUPPFEAT30APDG(
            null,
            m_db,
            m_prof,
            "SWSUPPFEAT30APDG");
        ...
        log("AFIRMT630AABR04 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Support Feature Base ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT630AABR04.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
