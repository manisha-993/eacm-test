...
*
<FEATURE_DELETE>		1
<ACTIVITY>	</ACTIVITY>	2	FEATURE	Activity
<DTSOFABR>	</DTSOFABR>	2	FEATURE	ABR Queued
<FEATUREENTITYTYPE>	</FEATUREENTITYTYPE>	2	FEATURE	ENTITYTYPE
<FEATUREENTITYID>	</FEATUREENTITYID>	2	FEATURE	ENTITYID
<DTSOFUPDATE>	</DTSOFUPDATE>	2	FEATURE	VALFROM
<FEATURECODE>	</FEATURECODE>	2	FEATURE	FEATURECODE
<PDHDOMAIN>	</PDHDOMAIN>	2	FEATURE	PDHDOMAIN
	</FEATURE_DELETE>	1
*
*/
// ADSDELFEATUREABR.java,v
...
//
//
public class ADSDELFEATUREABR extends XMLMQDelete
{
    private static final XMLElem XMLMAP;

    static {
        XMLMAP = new XMLGroupElem("FEATURE_DELETE");
         // level2
    ...
    *
	A.	MQ-Series CID
    */
    public String getMQCID() { return "FEATURE"; }
