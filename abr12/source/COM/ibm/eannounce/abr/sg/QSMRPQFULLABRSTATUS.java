...
**********************************************************************************/
//$Log: QSMRPQFULLABRSTATUS.java,v $
//Revision 1.27  2018/11/14 07:04:38  whwyue
//roll back code for MTP
//
//Revision 1.25  2018/10/18 07:31:15  whwyue
//Roll back code
//
 ...
 *
 */
public class QSMRPQFULLABRSTATUS extends PokBaseABR
{
    ...
    */
    ...
    public void execute_run()
    {
        ...
        try {
			...
			setDGTitle("QSMRPQFULLABRSTATUS report");
...
3.	'.txt'
     ...
     * @throws MiddlewareException
     */
	private void createT006FeatureRecords(EntityItem rootEntity, OutputStreamWriter wOut, EntityItem eiProdstruct, String strRootGenAreaSel) throws IOException, SQLException, MiddlewareException {
		...
		for(int i = 0; i < modelVect.size(); i++){
			...
			if (strRootGenAreaSel.equals("Latin America")
					|| strRootGenAreaSel.equals("Europe/Middle East/Africa")) {
			...
			if (strRootGenAreaSel.equals("US Only") || strRootGenAreaSel.equals("Canada and Caribbean North")){
				strASLMMVP = "1.00";
			} else if (strRootGenAreaSel.equals("Europe/Middle East/Africa") || strRootGenAreaSel.equals("Latin America")) {
			...
			if (strRootGenAreaSel.equals("Asia Pacific") || 
					strRootGenAreaSel.equals("US Only")) {
				strFAGRMBE = "N";
			} else if (strRootGenAreaSel.equals("Canada and Caribbean North")) {
				strFAGRMBE = "Y";
			} else if (strRootGenAreaSel.equals("Europe/Middle East/Africa") || strRootGenAreaSel.equals("Latin America")){
			...
			*/
			...
			if (eiWarr != null) {
				...
				if(warrTypeList != null){
					...
					if (strRootGenAreaSel.equals("Canada and Caribbean North")
							|| strRootGenAreaSel.equals("US Only")){
						strFSLM2CF = "N";
					}
				}
