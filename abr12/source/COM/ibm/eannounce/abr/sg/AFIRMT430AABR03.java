...
//
//AFIRMT430AABR03.java,v
//Revision 1.7  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.6  2006/01/24 16:43:17  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT430AABR03 extends PokBaseABR {
  /**
   *  Execute ABR.
   */

  // Class constants
  public final static String ABR = new String("AFIRMT430AABR03");
    ...
    try {
      ...
      try {
        if (getReturnCode() == PASS) {
          log("AFIRMT430AABR03 generating data");
          pdg =
            new SWSUBSPRODSUPP30APDG(
              null,
              m_db,
              m_prof,
              "SWSUBSPRODSUPP30APDG");
          pdg.setEntityItem(m_ei);
          pdg.executeAction(m_db, m_prof);
          log("AFIRMT430AABR03 finish generating data");
        }
  ...
  public String getDescription() {
    return "Software Subscription Product Support ABR.";
  }
  ...
  /**
   *  Gets the revision attribute of the AFIRMT430AABR03 object
   *
  ...
  /**
   *  Gets the version attribute of the AFIRMT430AABR03 class
   *
   *@return    The version value
   */
  public static String getVersion() {
    return ("AFIRMT430AABR03.java,v 1.7 2006/03/03 19:23:25 bala Exp");
  }

  /**
   *  Gets the aBRVersion attribute of the AFIRMT430AABR03 object
   *
   *@return    The aBRVersion value
   */
  public String getABRVersion() {
    return "AFIRMT430AABR03.java";
  }
}
