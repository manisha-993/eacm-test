...
//
//Revision 1.5  2006/01/24 16:50:27  yang
//Jtest Changes
//
//Revision 1.4  2004/10/05 21:19:58  bala
//change the description
//
//Revision 1.3  2004/09/15 18:29:50  bala
//typo in pdg actionitem parm
//
//Revision 1.2  2004/09/14 22:47:37  bala
//fix typo
//
//Revision 1.1  2004/09/14 22:40:11  bala
//check in
//
//
 ...
 */
public class PDG13MODUPGRABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("PDG13MODUPGRABR01");
  ...
  /**
    ...
    try {
      ...
      println(
        "<br><b>Hardware Model Upgrade Data Generator Request: "
          + m_ei.getKey()
          + "</b>");
      ...
      if (getReturnCode() == PASS) {
        log("PDG13MODUPGRABR01 generating data");
        pdg =
          new ACTPDG13MODUPGR(null, m_db, m_prof, "ACTPDG13MODUPGR");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("PDG13MODUPGRABR01 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Hardware Upgrade Model ABR";
  }
  ...
  /**
    ...
    return ("PDG13MODUPGRABR01.java,v 1.7 2008/01/30 19:39:15 wendy Exp");
  }
