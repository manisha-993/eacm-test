...
//
//AFIRMT630AABR06.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:42:41  yang
//Jtest Changes
//
//Revision 1.3  2005/02/08 18:29:14  joan
//changes for Jtest
//
//Revision 1.2  2004/09/10 20:22:37  joan
//fixes
//
//Revision 1.1  2004/09/03 00:03:40  joan
//add abrs
//
 ...
 */
public class AFIRMT630AABR06 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT630AABR06");
  ...
  public void execute_run() {
    ...
    try {
      ...
      println(
        "<br><b>Software Support Data Generator Request: "
          + m_ei.getKey()
          + "</b>");
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT630AABR06 generating data");
        pdg =
          new SWSUPPFEATSUPP30APDG(
            null,
            m_db,
            m_prof,
            "SWSUPPFEATSUPP30APDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT630AABR06 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Support Feature Support ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT630AABR06.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
