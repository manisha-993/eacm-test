...
//
//AFIRMT530AABR02.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:40:03  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT530AABR02 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT530AABR02");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT530AABR02 generating data");
        pdg =
          new SWMAINTPRODINI30APDG(
            null,
            m_db,
            m_prof,
            "SWMAINTPRODINI30APDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT530AABR02 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Maintenance Product Initial ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT530AABR02.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
