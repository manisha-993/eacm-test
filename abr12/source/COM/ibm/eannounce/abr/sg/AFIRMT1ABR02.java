...
//
//Revision 1.3  2006/01/24 17:04:31  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT1ABR02 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT1ABR02");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT1ABR02 generating data");
        pdg =
          new SWPRODUPGRADEPDG(
            null,
            m_db,
            m_prof,
            "SWPRODUPGRADEPDG");
        ...
        log("AFIRMT1ABR02 finish generating data");
      }
  ...
  */
  ...
  public static String getVersion() {
    return ("AFIRMT1ABR02.java,v 1.4 2006/03/03 19:23:25 bala Exp");
  }
