...
//
//AFIRMT530AABR06.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:40:24  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT530AABR06 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT530AABR06");
  ...
  public void execute_run() {
    SWMAINTFEATSUPP30APDG pdg = null;
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT530AABR06 generating data");
        pdg =
          new SWMAINTFEATSUPP30APDG(
            null,
            m_db,
            m_prof,
            "SWMAINTFEATSUPP30APDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT530AABR06 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Maintenance Feature Support ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT530AABR06.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
