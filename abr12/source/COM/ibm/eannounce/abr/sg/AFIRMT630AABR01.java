...
//
//AFIRMT630AABR01.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 17:06:10  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT630AABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT630AABR01");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT630AABR01 generating data");
        pdg =
          new SWSUPPPROD30APDG(
            null,
            m_db,
            m_prof,
            "SWSUPPPROD30APDG");
        ...
        log("AFIRMT630AABR01 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Support Product Base ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT630AABR01.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
