...
//
//AFIRMT530AABR04.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:40:14  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT530AABR04 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT530AABR04");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT530AABR04 generating data");
        pdg =
          new SWMAINFEAT30APDG(
            null,
            m_db,
            m_prof,
            "SWMAINFEAT30APDG");
        ...
        log("AFIRMT530AABR04 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Maintenance Feature Base ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT530AABR04.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
