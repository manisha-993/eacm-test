...
//
//AFIRMT630AABR02.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:41:16  yang
//Jtest Changes
//
...
//fixes
//
//Revision 1.1  2004/09/03 00:03:39  joan
//add abrs
//
 ...
 */
public class AFIRMT630AABR02 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT630AABR02");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT630AABR02 generating data");
        pdg =
          new SWSUPPPRODINI30APDG(
            null,
            m_db,
            m_prof,
            "SWSUPPPRODINI30APDG");
        ...
        log("AFIRMT630AABR02 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Support Product Initial ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT630AABR02.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
