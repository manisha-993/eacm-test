...
//
//AFIRMT130AABR01.java,v
//Revision 1.5  2008/06/16 19:35:22  wendy
//MN35609290 fix revealed memory leaks, deref() needed
//
//Revision 1.4  2006/03/03 19:23:24  bala
//remove reference to Constants.CSS
//
//Revision 1.3  2006/01/24 16:38:17  yang
//J-test
//
 ...
 */
public class AFIRMT130AABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = "AFIRMT130AABR01";
  ...
  public void execute_run() {
    ...
    try {
        ...
        log("AFIRMT130AABR01 generating data");
        spdg = new SPDGActionItem(null, m_db, m_prof, "SWSPDG1");
        spdg.setEntityItem(m_ei);
        spdg.executeAction(m_db, m_prof);
        setReturnCode(PASS);
        log("AFIRMT130AABR01 finish generating data");
        spdg.dereference();
  ...
  */
  ...
  public static String getVersion() {
    return ("AFIRMT130AABR01.java,v 1.5 2008/06/16 19:35:22 wendy Exp");
  }
