...
//
//AFIRMT530AABR01.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:40:37  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT530AABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT530AABR01");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT530AABR01 generating data");
        pdg =
          new SWMAINTPROD30APDG(
            null,
            m_db,
            m_prof,
            "SWMAINTPROD30APDG");
        ...
        log("AFIRMT530AABR01 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Maintenance Product Base ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT530AABR01.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
