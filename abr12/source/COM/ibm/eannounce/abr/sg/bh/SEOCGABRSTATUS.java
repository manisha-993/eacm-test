...
//
/**
SEOCGABRSTATUS_class=COM.ibm.eannounce.abr.sg.SEOCGABRSTATUS
SEOCGABRSTATUS_enabled=true
SEOCGABRSTATUS_idler_class=A
SEOCGABRSTATUS_keepfile=true
SEOCGABRSTATUS_read_only=true
SEOCGABRSTATUS_report_type=DGTYPE01
SEOCGABRSTATUS_vename=dummy

 *
 * SEOCGABRSTATUS.java,v
...
*
*/
public class SEOCGABRSTATUS extends DQABRSTATUS
{
    ...
    */
    ...
    {
        String desc =  "SEOCGABRSTATUS ABR.";
