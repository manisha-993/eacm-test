...
//Revision 1.52  2020/04/08 08:06:01  xujianbo
//Recover code  for stroyt Svc Prof- Prdt Tax Clsf reqt (CHIS/TSS only)
//
//Revision 1.50  2020/02/18 12:51:23  xujianbo
//Recover code  for stroyt Svc Prof- Prdt Tax Clsf reqt (CHIS/TSS only)
//
//Revision 1.48  2019/12/17 08:19:42  xujianbo
//Synchronize the codes between the old and new servers
//
//Revision 1.50  2019/11/26 09:01:06  xujianbo
//Recover code for stroy Svc Prof- Prdt Tax Clsf reqt (CHIS/TSS only)
//
//Revision 1.48  2019/11/18 09:54:34  xujianbo
//Add RFAGeo for those three countries- Development
//Svc Prof- Prdt Tax Clsf reqt (CHIS/TSS only)- Development
//
//Revision 1.47  2018/11/20 14:12:20  dlwlan
//Story 1917456: Add wddate and wd eff date for service prod structure
//
//Revision 1.46  2018/11/14 09:33:21  dlwlan
//Roll back Story 1917456 code change
//
//Revision 1.45  2018/11/05 14:16:16  dlwlan
//Story 1917456: Add wddate and wd eff date for service prod structure
//
//Revision 1.44  2018/02/12 13:09:04  wangyul
//Story 1799258 GBS product structure support for Features
//
//Revision 1.42  2018/02/08 12:26:17  wangyul
//Story 1799258 GBS product structure support for Features
//
...
public class ADSSVCMODABR extends XMLMQRoot
{
    ...
    static {
        ...
        XMLElem elem = new XMLDistinctGroupElem(null,"SGMNTACRNYM","D:SVCMODSGMTACRONYMA:D",true,true);
        XMLMAP.addChild(elem);
        //elem.addChild(new XMLElem("DIVISION","DIV"));
...
//		Add	CQ 41622 - update mapping	22.50		1	1.0	<PCTOFCMPLTINDC>	</PCTOFCMPLTINDC>	2	SVCMOD_UPDATE /PCTOFCMPLTINDC		ADSSVCMOD	Root Entity	SVCMOD	PCTOFCMPLTINDC		Long Description	"Yes", "No"	Always
        ...
        elemSVCMODTAXRELEVANCE.addChild(new XMLTAXElem("TAXCLASSIFICATION","TAXCLS",XMLElem.SHORTDESC));
...
//        eREFPRCPTELEMENT.addChild(new XMLElem("REFPRCPTID","PRCPTID"));
        ...
        //level 2 <PRODSTRUCTLIST>
        list = new XMLGroupElem("PRODSTRUCTLIST","SVCPRODSTRUCT");
        XMLMAP.addChild(list);
        // level 3
        XMLElem ePRODSTRUCTELEMENT = new XMLElem("PRODSTRUCTELEMENT");
        list.addChild(ePRODSTRUCTELEMENT);
        // level 4  the xml type is XMLActivityElem
        ePRODSTRUCTELEMENT.addChild(new XMLActivityElem("ACTIVITY"));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("ENTITYTYPE","ENTITYTYPE"));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("ENTITYID","ENTITYID"));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("STATUS","STATUS", XMLElem.FLAGVAL));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("MKTGNAME","MKTGNAME"));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("MNATORYOPT","MNATORYOPT", XMLElem.FLAGVAL));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("OWNERID","OWNERID"));
        //add WITHDRAWDATE and WTHDRWEFFCTVDATE at 20181102
        ePRODSTRUCTELEMENT.addChild(new XMLElem("WITHDRAWDATE","WITHDRAWDATE"));
        ePRODSTRUCTELEMENT.addChild(new XMLElem("WTHDRWEFFCTVDATE","WTHDRWEFFCTVDATE"));
        
        XMLElem eSVCFEATURE = new XMLGroupElem(null,"SVCFEATURE","U:SVCFEATURE");
        ePRODSTRUCTELEMENT.addChild(eSVCFEATURE);
        eSVCFEATURE.addChild(new XMLElem("FEATURECODE","FEATURECODE"));
        eSVCFEATURE.addChild(new XMLElem("FCMKTGSHRTDESC","FCMKTGSHRTDESC"));
        eSVCFEATURE.addChild(new XMLElem("SVCCAT","SVCFCCAT"));
        eSVCFEATURE.addChild(new XMLElem("SVCFCSUBCAT","SVCFCSUBCAT"));
        eSVCFEATURE.addChild(new XMLElem("EFFECTIVEDATE","EFFECTIVEDATE"));
        eSVCFEATURE.addChild(new XMLElem("ENDDATE","ENDDATE"));
