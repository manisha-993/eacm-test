...
//
//AFIRMT130AABR04.java,v
//Revision 1.4  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.3  2006/01/24 16:39:25  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT130AABR04 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT130AABR04");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT130AABR04 generating data");
        pdg =
          new SWOFUPGRADE30APDG(
            null,
            m_db,
            m_prof,
            "SWOFUPGRADE30APDG");
        ...
        log("AFIRMT130AABR04 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Optional Feature Upgrade ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT130AABR04.java,v 1.4 2006/03/03 19:23:25 bala Exp");
  }
