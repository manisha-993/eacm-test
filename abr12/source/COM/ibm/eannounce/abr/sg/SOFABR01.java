...
//
//SOFABR01.java,v
//Revision 1.8  2006/03/13 19:42:03  couto
//Fixed copyright info.
//
//Revision 1.7  2006/03/13 18:04:00  couto
//Fixed table summary.
//
//Revision 1.6  2006/03/13 17:54:18  couto
 ...
 *  This ABR sets SOFSTATUS to ‘Ready for Review’ or 'Final'.
 *  Return Code
 *  Pass
 *
 *@author     Yang
 *@created    Oct 13,2003
 */
public class SOFABR01 extends PokBaseABR {
  ...
  //ABR
  public final static String ABR = "SOFABR01";
  ...
  /**
     ...
     *
     */
    public final static String SOFSTATUS = "SOFSTATUS";
  ...
  //SOFSTATUS  Ststus Attribute Ready for Final Review
  private final String m_strFinalValue = "112";
  //SOFSTATUS  Ststus Attribute Ready for Final Review

  private EntityGroup m_egParent = null; //SOF

  private EntityItem m_eiParent = null; //SOF
  ...
  /**
    ...
    try {
      ...
      if (m_egParent == null) {
        ...
        EANAttribute attabrset = m_eiParent.getAttribute(ABRSET);
        String abrsetStatusvalue =
          (attabrset != null ? attabrset.toString() : DEF_NOT_POPULATED_HTML);
        logMessage(
          "***abrsetStatusvalue***: "
        ...
        att = m_eiParent.getAttribute(SOFSTATUS);
        strStatusvalue =
        ...
        strStatus = getFlagCode(m_eiParent, SOFSTATUS);
        logMessage(
          "****strStatus:"
            + m_eiParent.getEntityType()
            + "-"
        ...
        //check to move SOFSTATUS to Final
        if (abrsetStatus.equals("0020")) {
          ...
          //check to move SOFSTATUS to Ready for Review
          ...
          if ((strStatus.equals("111") || strStatus.equals("115"))
            ...
            println(
              "<br /><br /><b>Offering MKTG Status"
                ...
                + "</b>"
                + strStatus4);
            setReadyForReviewValue(SOFSTATUS);
            setReturnCode(PASS);
      ...
      setDGRptName("SOFABR01"); //Set the report name
      setDGRptClass("SOFABR01"); //Set the report class
  ...
  /**
   *  Sets the flagValue attribute of the SOFABR01 object
   *
  ...
  public void setReadyForReviewValue(
    ...
    if (_sAttributeCode.equals(SOFSTATUS)) {
      logMessage("****** SOF Status set to: " + m_strReadyForReviewValue);
  ...
  /**
    ...
    if (_sAttributeCode.equals(SOFSTATUS)) {
      logMessage("****** SOF Status set to: " + m_strFinalValue);
  ...
  /**
    ...
    return ("SOFABR01.java,v 1.8 2006/03/13 19:42:03 couto Exp");
  }
  ...
  private void buildRptHeader() throws SQLException, MiddlewareException{
	  ...
	  println("<head>");
	  println(EACustom.getMetaTags("SOFABR01.java"));
