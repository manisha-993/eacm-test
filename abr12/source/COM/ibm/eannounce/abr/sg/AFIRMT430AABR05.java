...
//
//AFIRMT430AABR05.java,v
//Revision 1.7  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.6  2006/01/24 16:40:53  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT430AABR05 extends PokBaseABR {
  /**
   *  Execute ABR.
   */

  // Class constants
  public final static String ABR = new String("AFIRMT430AABR05");
    ...
    try {
      ...
      try {
        if (getReturnCode() == PASS) {
          log("AFIRMT430AABR05 generating data");
          pdg =
            new SWSUBSFEATINI30APDG(
              null,
              m_db,
              m_prof,
              "SWSUBSFEATINI30APDG");
          ...
          log("AFIRMT430AABR05 finish generating data");
        }
  ...
  public String getDescription() {
    return "Software Subscription Feature Initial ABR.";
  }
  ...
  /**
   *  Gets the revision attribute of the AFIRMT430AABR05 object
   *
  ...
  /**
   *  Gets the version attribute of the AFIRMT430AABR05 class
   *
   *@return    The version value
   */
  public static String getVersion() {
    return ("AFIRMT430AABR05.java,v 1.7 2006/03/03 19:23:25 bala Exp");
  }

  /**
   *  Gets the aBRVersion attribute of the AFIRMT430AABR05 object
   *
   *@return    The aBRVersion value
   */
  public String getABRVersion() {
    return "AFIRMT430AABR05.java";
  }
}
