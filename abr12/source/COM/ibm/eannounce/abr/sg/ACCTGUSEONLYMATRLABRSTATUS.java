...
/**********************************************************************************
* ACCTGUSEONLYMATRLABRSTATUS class
*
* From "SG FS ABR Data Quality 20070911.doc"
*
* The ABR sets its unique attribute (ACCTGUSEONLYMATRLABRSTATUS)
ACCTGUSEONLYMATRLABRSTATUS_class=COM.ibm.eannounce.abr.sg.ACCTGUSEONLYMATRLABRSTATUS
ACCTGUSEONLYMATRLABRSTATUS_enabled=true
ACCTGUSEONLYMATRLABRSTATUS_idler_class=A
ACCTGUSEONLYMATRLABRSTATUS_keepfile=true
ACCTGUSEONLYMATRLABRSTATUS_read_only=true
ACCTGUSEONLYMATRLABRSTATUS_report_type=DGTYPE01
ACCTGUSEONLYMATRLABRSTATUS_vename=SAPLVEACCTMATRL
*/
// ACCTGUSEONLYMATRLABRSTATUS.java,v
// Revision 1.8  2007/10/26 12:15:32  couto
// Updates per spec changes.
//
// Revision 1.7  2007/10/23 17:45:46  wendy
// data model chgs
//
// Revision 1.6  2007/10/15 20:22:35  wendy
// QueueSAPL when PDHDOMAIN is not in list of domains
//
// Revision 1.5  2007/09/14 17:43:54  wendy
// Updated for GX
//
// Revision 1.4  2007/08/17 16:02:09  wendy
...
//
// Revision 1.2  2007/04/20 14:05:59  wendy
// RQ0417075638 updates
//
// Revision 1.1  2007/04/02 17:41:09  wendy
// Init for SAPL abr
//
public class ACCTGUSEONLYMATRLABRSTATUS extends DQABRSTATUS
{
	/**********************************
    ...
    *
    *1.	CountOf(ACCTMATRLGEODATE-d: GEODATE => 1
    ...
    *D.	STATUS = Final
    *
    *Data Quality checks are not required. This occurs when data is sent to SAPL but there is a
    *downstream failure which requires the XML to be sent again. The UI allows the setting of SAPL
    *to Send which will queue this ABR.
    *
    ...
    */
    protected void doDQChecking(EntityItem rootEntity, String statusFlag) throws Exception
    {
		...
		{
			int cnt = getCount("ACCTMATRLGEODATE");
			if(cnt == 0)	{
    ...
    */
    ...
    {
        String desc =  "ACCTGUSEONLYMATRL ABR";
        return desc;
    }
