...
//
//AFIRMT130AABR02.java,v
//Revision 1.5  2006/03/03 19:23:24  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 16:38:35  yang
//J-test
//
//Revision 1.3  2005/02/08 18:29:13  joan
//changes for Jtest
//
//Revision 1.2  2004/08/27 23:30:32  joan
//fixes
//
//Revision 1.1  2004/08/27 23:12:45  joan
//add new abrs
//
 ...
 */
public class AFIRMT130AABR02 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT130AABR02");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT130AABR02 generating data");
        pdg =
          new SWPRODUPGRADE30APDG(
            null,
            m_db,
            m_prof,
            "SWPRODUPGRADE30APDG");
        ...
        log("AFIRMT130AABR02 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Product Upgrade ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT130AABR02.java,v 1.5 2006/03/03 19:23:24 bala Exp");
  }
