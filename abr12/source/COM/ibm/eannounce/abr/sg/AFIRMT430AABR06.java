...
//
//AFIRMT430AABR06.java,v
//Revision 1.7  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.6  2006/01/24 16:39:49  yang
//Jtest Changes
//
//Revision 1.5  2005/02/08 18:29:13  joan
//changes for Jtest
//
//Revision 1.4  2004/10/10 20:53:52  bala
//to update AFPDGERRORMSG on PDGerror
//
 ...
 */
public class AFIRMT430AABR06 extends PokBaseABR {
  /**
   *  Execute ABR.
   */

  // Class constants
  public final static String ABR = new String("AFIRMT430AABR06");
  ...
  //private final String m_strLogError = "";
    ...
    try {
      ...
      try {
        if (getReturnCode() == PASS) {
          log("AFIRMT430AABR06 generating data");
          pdg =
            new SWSUBSFEATSUPP30APDG(
              null,
              m_db,
              m_prof,
              "SWSUBSFEATSUPP30APDG");
          pdg.setEntityItem(m_ei);
          pdg.executeAction(m_db, m_prof);
          log("AFIRMT430AABR06 finish generating data");
        }
        ...
        sbError.append(_sbrex.toString());
        list.put("AFPDGERRORMSG", "AFPDGERRORMSG= " + sbError);
  ...
  public String getDescription() {
    return "Software Subscription Feature Support ABR.";
  }
  ...
  /**
   *  Gets the revision attribute of the AFIRMT430AABR06 object
   *
  ...
  /**
   *  Gets the version attribute of the AFIRMT430AABR06 class
   *
   *@return    The version value
   */
  public static String getVersion() {
    return ("AFIRMT430AABR06.java,v 1.7 2006/03/03 19:23:25 bala Exp");
  }

  /**
   *  Gets the aBRVersion attribute of the AFIRMT430AABR06 object
   *
   *@return    The aBRVersion value
   */
  public String getABRVersion() {
    return "AFIRMT430AABR06.java";
  }
}
