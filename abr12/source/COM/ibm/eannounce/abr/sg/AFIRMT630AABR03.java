...
//
//AFIRMT630AABR03.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 17:06:31  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT630AABR03 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT630AABR03");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT630AABR03 generating data");
        pdg =
          new SWSUPPPRODSUPP30APDG(
            null,
            m_db,
            m_prof,
            "SWSUPPPRODSUPP30APDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT630AABR03 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Support Product Support ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT630AABR03.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
