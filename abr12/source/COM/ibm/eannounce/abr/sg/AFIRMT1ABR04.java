...
//
//Revision 1.3  2006/01/24 17:04:56  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT1ABR04 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT1ABR04");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT1ABR04 generating data");
        pdg =
          new SWOFUPGRADEPDG(null, m_db, m_prof, "SWOFUPGRADEPDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT1ABR04 finish generating data");
      }
  ...
  */
  ...
  public static String getVersion() {
    return ("AFIRMT1ABR04.java,v 1.4 2006/03/03 19:23:25 bala Exp");
  }
