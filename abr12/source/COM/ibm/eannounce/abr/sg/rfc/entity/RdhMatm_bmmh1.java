...
/**
 * BMMH1 for MATERIAL CREATION RFC
 * @author will
 * @since 07/28/2021
 */
public class RdhMatm_bmmh1
{
    ...
    @SerializedName("LFGJA")
    private String lfgja;
    @SerializedName("LFMON")
    ...
    private String zztrm;
    @SerializedName("ZZRNWML")
    private String zzrnwml;
    @SerializedName("ZZBILFRU")
    private String zzbilfru;
    @SerializedName("ZZBILFRM")
    private String zzbilfrm;
    @SerializedName("ZZBILFRQ")
    private String zzbilfrq;
    @SerializedName("ZZBILFRA")
    private String zzbilfra;
    @SerializedName("ZZBILFRE")
    private String zzbilfre;
    @SerializedName("DSW_PART_TYPE")
     ...
     * @return the lfmng
     */
    public String getLfmng()
    {
        return lfmng;
    }
    /**
     * @param lfmng the lfmng to set
     */
    public void setLfmng(String lfmng)
    {
        this.lfmng = lfmng;
    }
    /**
     * @return the scmng
     */
    public String getScmng()
    {
        return scmng;
    }
    /**
     * @param scmng the scmng to set
     */
    public void setScmng(String scmng)
    {
        this.scmng = scmng;
    }
    /**
     ...
     * @return the vmvpr
     */
    public String getVmvpr()
    {
        return vmvpr;
    }
    /**
     * @param vmvpr the vmvpr to set
     */
    public void setVmvpr(String vmvpr)
    {
        this.vmvpr = vmvpr;
    }
    /**
     * @return the vmbkl
     */
    public String getVmbkl()
    {
        return vmbkl;
    }
    /**
     * @param vmbkl the vmbkl to set
     */
    public void setVmbkl(String vmbkl)
    {
        this.vmbkl = vmbkl;
    }
    /**
     * @return the vjvpr
     */
    public String getVjvpr()
    {
        return vjvpr;
    }
    /**
     * @param vjvpr the vjvpr to set
     */
    public void setVjvpr(String vjvpr)
    {
        this.vjvpr = vjvpr;
    }
    /**
     * @return the vjbkl
     */
    public String getVjbkl()
    {
        return vjbkl;
    }
    /**
     * @param vjbkl the vjbkl to set
     */
    public void setVjbkl(String vjbkl)
    {
        this.vjbkl = vjbkl;
    }
    /**
    ...
    /**
     * @param zeiar the zeiar to set
     */
    public void setZeiar(String zeiar)
    {
        this.zeiar = zeiar;
    }
    /**
     ...
     * @return the zzpht
     */
    public String getZzpht()
    {
        return zzpht;
    }
    /**
     * @param zzpht the zzpht to set
     */
    public void setZzpht(String zzpht)
    {
        this.zzpht = zzpht;
    }
    /**
     * @return the zztrm
     */
    public String getZztrm()
    {
        return zztrm;
    }
    /**
     * @param zztrm the zztrm to set
     */
    public void setZztrm(String zztrm)
    {
        this.zztrm = zztrm;
    }
    /**
     * @return the zzrnwml
     */
    public String getZzrnwml()
    {
        return zzrnwml;
    }
    /**
     * @param zzrnwml the zzrnwml to set
     */
    public void setZzrnwml(String zzrnwml)
    {
        this.zzrnwml = zzrnwml;
    }
    /**
     * @return the zzbilfru
     */
    public String getZzbilfru()
    {
        return zzbilfru;
    }
    /**
     * @param zzbilfru the zzbilfru to set
     */
    public void setZzbilfru(String zzbilfru)
    {
        this.zzbilfru = zzbilfru;
    }
    /**
     * @return the zzbilfrm
     */
    public String getZzbilfrm()
    {
        return zzbilfrm;
    }
    /**
     * @param zzbilfrm the zzbilfrm to set
     */
    public void setZzbilfrm(String zzbilfrm)
    {
        this.zzbilfrm = zzbilfrm;
    }
    /**
     * @return the zzbilfrq
     */
    public String getZzbilfrq()
    {
        return zzbilfrq;
    }
    /**
     * @param zzbilfrq the zzbilfrq to set
     */
    public void setZzbilfrq(String zzbilfrq)
    {
        this.zzbilfrq = zzbilfrq;
    }
    /**
     * @return the zzbilfra
     */
    public String getZzbilfra()
    {
        return zzbilfra;
    }
    /**
     * @param zzbilfra the zzbilfra to set
     */
    public void setZzbilfra(String zzbilfra)
    {
        this.zzbilfra = zzbilfra;
    }
    /**
     * @return the zzbilfre
     */
    public String getZzbilfre()
    {
        return zzbilfre;
    }
    /**
     * @param zzbilfre the zzbilfre to set
     */
    public void setZzbilfre(String zzbilfre)
    {
        this.zzbilfre = zzbilfre;
    }
    /**
     * @return the dsw_part_type
     */
    public String getDsw_part_type()
    {
        return dsw_part_type;
    }
    /**
     * @param dsw_part_type the dsw_part_type to set
     */
    public void setDsw_part_type(String dsw_part_type)
    {
        this.dsw_part_type = dsw_part_type;
    }
    /**
     * @return the mvgr1
     */
