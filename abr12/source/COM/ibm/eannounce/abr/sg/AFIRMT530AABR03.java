...
//
//AFIRMT530AABR03.java,v
//Revision 1.5  2006/03/03 19:23:25  bala
//remove reference to Constants.CSS
//
//Revision 1.4  2006/01/24 17:05:36  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT530AABR03 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT530AABR03");
  ...
  public void execute_run() {
    SWMAINTPRODSUPP30APDG pdg = null;
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT530AABR03 generating data");
        pdg =
          new SWMAINTPRODSUPP30APDG(
            null,
            m_db,
            m_prof,
            "SWMAINTPRODSUPP30APDG");
        pdg.setEntityItem(m_ei);
        pdg.executeAction(m_db, m_prof);
        log("AFIRMT530AABR03 finish generating data");
      }
  ...
  */
  ...
  public String getDescription() {
    return "Software Maintenance Product Support ABR.";
  }
  ...
  public static String getVersion() {
    return ("AFIRMT530AABR03.java,v 1.5 2006/03/03 19:23:25 bala Exp");
  }
