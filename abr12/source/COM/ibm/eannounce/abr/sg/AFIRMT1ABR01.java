...
//
//Revision 1.3  2006/01/24 17:04:20  yang
//Jtest Changes
//
 ...
 */
public class AFIRMT1ABR01 extends PokBaseABR {
  /**
  *  Execute ABR.
  *
  */
  ...
  // Class constants
  public final static String ABR = new String("AFIRMT1ABR01");
  ...
  public void execute_run() {
    ...
    try {
      ...
      if (getReturnCode() == PASS) {
        log("AFIRMT1ABR01 generating data");
        spdg =
          new SPDGActionItem(null, m_db, m_prof, "SWSPDG1");
        spdg.setEntityItem(m_ei);
        spdg.executeAction(m_db, m_prof);
        log("AFIRMT1ABR01 finish generating data");
      }
  ...
  */
  ...
  public static String getVersion() {
    return ("AFIRMT1ABR01.java,v 1.4 2006/03/03 19:23:25 bala Exp");
  }
