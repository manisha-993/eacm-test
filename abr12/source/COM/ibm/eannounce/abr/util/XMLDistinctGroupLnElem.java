...
/*     */ 
/*     */ 
/*     */ public class XMLDistinctGroupLnElem
/*     */   extends XMLElem
/*     */ {
...
/*     */ 
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, boolean paramBoolean2) {
...
/*     */ 
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString1, String paramString2, String paramString3, boolean paramBoolean) {
...
/*     */   }
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString1, String paramString2, String paramString3, boolean paramBoolean, int paramInt) {
...
/*     */ 
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString1, String paramString2, String paramString3) {
...
/*     */ 
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString1, String paramString2) {
...
/*     */ 
/*     */   
/*     */   public XMLDistinctGroupLnElem(String paramString) {
...
/* 608 */           for (byte b1 = 0; b1 < vector.size(); b1++) {
/* 609 */             DiffEntity diffEntity = vector.elementAt(b1);
/* 610 */             if (!diffEntity.isDeleted()) {
/* 611 */               vector1.add(diffEntity);
/*     */               
/*     */               break;
/*     */             } 
/*     */           } 
...
/*     */       } 
/*     */       
/* 620 */       if (this.isMultUse) {
/*     */         
/* 622 */         HashMap<Object, Object> hashMap = new HashMap<>();
/* 623 */         Vector vector1 = new Vector();
/* 624 */         for (byte b1 = 0; b1 < vector.size(); b1++) {
/* 625 */           DiffEntity diffEntity = vector.elementAt(b1);
/* 626 */           ABRUtil.append(paramStringBuffer, "XMLDistinctGroupElem.getItems: dffFeature=" + diffEntity.getKey() + " isDelete" + diffEntity.isDeleted() + " isNew" + diffEntity.isNew() + " isUpdate" + diffEntity.isChanged() + NEWLINE);
/*     */ 
/*     */           
/* 629 */           if ("FEATURE|SWFEATURE".equals(this.etype)) {
/* 630 */             if (diffEntity.toString().indexOf("LSEOPRODSTRUCT") > 0 || diffEntity.toString().indexOf("LSEOSWPRODSTRUCT") > 0 || diffEntity.toString().indexOf("WWSEOPRODSTRUCT") > 0 || diffEntity.toString().indexOf("WWSEOSWPRODSTRUCT") > 0) {
...
/*     */             } 
/*     */           } else {
/* 637 */             String str = diffEntity.getKey();
/* 638 */             if (!hashMap.containsKey(str)) {
/* 639 */               hashMap.put(str, diffEntity);
/*     */             }
/*     */           } 
/*     */         } 
/* 643 */         Collection collection = hashMap.values();
/* 644 */         vector1.addAll(collection);
/* 645 */         return vector1;
/*     */       } 
/*     */     } 
/*     */ 
...
/* Location:              C:\Users\06490K744\Documents\fromServer\deployments\codeSync2\abr.jar!\COM\ibm\eannounce\ab\\util\XMLDistinctGroupLnElem.class
