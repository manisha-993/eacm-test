...
public class XMLDistinctGroupLnElem extends XMLElem
{
     ...
     */
    public XMLDistinctGroupLnElem(String nname, String type, String _path,boolean _isMultUse, boolean _isOnce)
    {
    	super(nname);
        etype = type;
        path = _path;
     ...
     *@param _isMultUse boolean with isNesting to check whether XMLGroupElem has a nesting list after leve 2
     */
    public XMLDistinctGroupLnElem(String nname, String type, String _path,boolean _isMultUse)
    {
    	super(nname);
        etype = type;
        path = _path;
    ...
    public XMLDistinctGroupLnElem(String nname, String type, String _path,boolean _isMultUse,int _ilevel)
    {
    	super(nname);
        etype = type;
        path = _path;
    ...
    *@param _path String with path to use to get to this group D:MODELAVAIL:D where type = AVAIL
    */
    public XMLDistinctGroupLnElem(String nname, String type, String _path)
    {
        super(nname);
        etype = type;
        path = _path;
    ...
    *@param type String with entity type
    */
    public XMLDistinctGroupLnElem(String nname, String type)
    {
        super(nname);
        etype = type;
	}
    ...
    */
    public XMLDistinctGroupLnElem(String nname)
    {
        super(nname);
        etype = "ROOT";
	}
					...
					if(isOnce){
						...
						if(vct.size()>0){
							for(int i=0;i<vct.size();i++){
								DiffEntity diffEntity = (DiffEntity)vct.elementAt(i);
								if(!diffEntity.isDeleted()){
