...
public class XMLAVAILElem extends XMLElem
{
    ...
    */
        ...
        COM.ibm.opicmpdh.middleware.MiddlewareShutdownInProgressException
    {
    	boolean isfromModel = isDerivefromModel(table,parentItem,debugSb);
      	if (isfromModel == true ){
    		createNodeFromModel(dbCurrent, document, parent, parentItem, debugSb);
      	}else{
...
//    			annVct.clear();
	 ...
	 */
	private void createNodeFromModel(Database dbCurrent, Document document, Element parent, DiffEntity parentItem, StringBuffer debugSb) throws SQLException, MiddlewareException {
