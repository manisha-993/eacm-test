...
public class XMLRelatorSearchElem extends XMLSearchElem
{
    ...
    */
    public XMLRelatorSearchElem(String downnname, String upnname, String srchAct,
    	String stype)
    {
    ...
    */
        ...
        COM.ibm.opicmpdh.middleware.MiddlewareShutdownInProgressException
    {
        ...
        try{
        	//do speical check, if rootentity is FEATURE Transaction and FromModel/ToModel is empty ,then Modelentityid = empty and Featureentityid using Featurecode search.
        	if ("FCTRANSACTION".equals(parentItem.getEntityType()) && "FROMMODELENTITYID".equals(nodeName)){        		
    			...
    			if (CHEAT.equals(frommodel)){
    				emptymod = true;
    				//MODELENITYID is empty, FEATUREENTITYID has same value , according to FEATURECODE to search. 
    			
    				 EntityItem[] feaarry = SearchFeature(parentItem, dbCurrent, "FROMFEATURECODE", debugSb);
          	...
          	if ("FCTRANSACTION".equals(parentItem.getEntityType()) && "TOMODELENTITYID".equals(nodeName)){        		
    			...
    			if (CHEAT.equals(tomodel)){
    				//MODELENITYID is empty, FEATUREENTITYID has same value , according to FEATURECODE to search. 
    				emptymod = true;
    				 EntityItem[] feaarry = SearchFeature(parentItem, dbCurrent, "TOFEATURECODE", debugSb);
    				 if (feaarry!= null && feaarry.length >0){
    						EntityItem feaitem = feaarry[0];   					
    		                upvalue = ""+feaitem.getEntityID();    				    		              
    		            }
    ...
    */
    ...
    throws MiddlewareBusinessRuleException, MiddlewareRequestException, SQLException, 
