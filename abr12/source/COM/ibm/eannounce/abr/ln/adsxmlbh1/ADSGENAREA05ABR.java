...
//
//
public class ADSGENAREA05ABR extends XMLMQAdapter
{
    ...
    */
	...
	MissingResourceException
    {
		...
		abr.addDebug("ADSGENAREA05ABR.processThis checking between "+t1DTS+" and "+t2DTS);
		// find GENAREA
		...
		if (genVct.size()==0){
			...
			abr.addDebug("ADSGENAREA05ABR.processThis found "+genVct.size()+" GENERALAREA");

			//Hashtable VersionmqVct = getMQPropertiesVN(rootEntity,abr);
			//String key05 = "05";
			//Vector mqVct = (Vector)VersionmqVct.get(key05);
			Vector mqVct = getPeriodicMQ(rootEntity);//new add
			if (mqVct==null){
				abr.addDebug("ADSGENAREA05ABR: No MQ properties files, nothing will be generated.");
				...
				parent.appendChild(document.createComment("GENERALAREA_UPDATE Version "+XMLVERSION05+" Mod "+XMLMOD05));
				...
				abr.addDebug("ADSGENAREA05ABR: Generated MQ xml:"+ADSABRSTATUS.NEWLINE+xml+ADSABRSTATUS.NEWLINE);
