...
public class ADSLSEOABR extends XMLMQRoot
{
    ...
    static {
        ...
        //XMLElem elemPROJ = new XMLDistinctGroupElem(null,"PROJ","U:WWSEOLSEO:U:WWSEO:D:WWSEOPROJA:D",true,true);
        XMLElem elemPROJ = new XMLDistinctGroupLnElem(null,"PROJ",null,true,true);
        elemwwseo.addChild(elemPROJ);
...
//        Add	CQ 32374 	231.00			1.0		</REPLLSEOLIST>	2	SEO_UPDATE  /REPLLSEOLIST																																			
    ...
    */
    ...
    /* (non-Javadoc)
     * @see COM.ibm.eannounce.abr.ln.adsxmlbh1.XMLMQAdapter#mergeLists(COM.ibm.eannounce.abr.ln.adsxmlbh1.ADSABRSTATUS, COM.ibm.eannounce.objects.EntityList, COM.ibm.eannounce.objects.EntityList)
     */
    protected void mergeLists(ADSABRSTATUS abr, EntityList list1, EntityList list2) throws
    java.sql.SQLException,
    COM.ibm.opicmpdh.middleware.MiddlewareException,
