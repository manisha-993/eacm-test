...
public interface XMLMQ
{
    ...
    */
    Vector getMQPropertiesFN(EntityItem rootEntity,ADSABRSTATUS abr);
    
    /**********************************
     * check if mq series properties file name attribute is active on root entity.
     * If it is, then this indicates an IDL.
     */
     boolean checkIDLMQPropertiesFN(EntityItem rootEntity);
