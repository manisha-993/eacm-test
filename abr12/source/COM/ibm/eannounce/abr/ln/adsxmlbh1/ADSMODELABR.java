...
// For the RCQ246579 - EACM SWMA Indicator that Add mapping for MODEL.SWMAIND to MODEL_UPDATE XML
//
// Revision 1.41  2012/12/13 02:27:36  wangyulo
// Fix the defect 853887 --There are multiple <EFFECTIVEDATE>,<ENDDATE>and <UNBUNDTYPE> in MODEL XML
//
...
// Fixed the CQ 197268 --  map MODEL_UPDATE/SUBCATEGORY from COFSUBCAT short description rather than long description
// base on the new document BH FS ABR Data Transformation System Feed Mapping - DM4 20120112.xls
// And also fix the part of issues 635138 for the MODEL abr -- Code issue,mismatch with XSD,it should show <DIVISION> tag once in xml report for the MODEL ABR
//
...
// CQ ?????	Add PRODSUPRTCD
// CHIS/CEDS	Add MACHRATECATG, CECSPRODKEY, MAINTANNBILLELIGINDC, NOCHRGMAINTINDC, RETANINDC
//
...
public class ADSMODELABR extends XMLMQRoot
{
    ...
    static {
        ...
        //Change for CQ 197268 - change mapping of MODEL_UPDATE /SUBCATEGORY to short description 2012-1-13
        ...
        XMLElem elemPROJ = new XMLDistinctGroupElem(null,"PROJ","D:MODELPROJA:D",true,true); //<DIVISION>	</DIVISION>			2	SGMNTACRNYM	DIV
...
//        Change	Change attribute name - CQ 36618	41.20		1	1.0	<WARRSVCCOVR>	</WARRSVCCOVR>	2	MODEL_UPDATE /WARRSVCCOVR			MODEL	WARRSVCCOVR		Short Description	"None
//        National
//        International"	Always			
        ...
        //XMLMAP.addChild(new XMLElem("PRPQINDC","SPECBID")); Replaced by SPECBID + PRPQAPPRVTYPE
        ...
        //Add	CQ 28348	56.00		1	1.0	<SVCLEVCD>	</SVCLEVCD>	2	MODEL_UPDATE /SVCLEVCD			MODEL	SVCLEVCD		Text
//        Add	CQ 28348	56.50		1	1.0	<ENDCUSTIDREQ>	</ENDCUSTIDREQ>	2	MODEL_UPDATE /ENDCUSTIDREQ			MODEL	ENDCUSTIDREQ		Long Description
//        Add	CQ 28348	57.00		1	1.0	<ENTITLMENTSCOPE>	</ENTITLMENTSCOPE>	2	MODEL_UPDATE /ENTITLMENTSCOPE			MODEL	ENTITLMENTSCOPE		Short Description
//        Add	CQ 28348	57.50		1	1.0	<PRORATEDOTCALLOW>	</PRORATEDOTCALLOW>	2	MODEL_UPDATE /PRORATEDOTCALLOW			MODEL	PRORATEDOTCALLOW		Long Description
//        Add	CQ 28348	58.00		1	1.0	<SVCGOODSENTITL>	</SVCGOODSENTITL>	2	MODEL_UPDATE /SVCGOODSENTITL			MODEL	SVCGOODSENTITL		Short Description
//        Add	CQ 28348	58.50		1	1.0	<TYPEOFWRK>	</TYPEOFWRK>	2	MODEL_UPDATE /TYPEOFWRK			MODEL	TYPEOFWRK		Short Description
...
//        Add	MDM 099, MDM 116	56.00		1	1.0	<SDFCD>	</SDFCD>	2	MODEL_UPDATE /SDFCD			MODEL	SDFCD		TBD (new attribute)		Always
//        Add	MDM 099, MDM 116	56.50		1	1.0	<SVCPACMACHBRAND>	</SVCPACMACHBRAND>	2	MODEL_UPDATE /SVCPACMACHBRAND		MODELSVC -d	SVC	SVCPACMACHBRAND		TBD (new attribute)		Always
//        Add	MDM 099, MDM 116	57.00		1	1.0	<COVRPRIOD>	</COVRPRIOD>	2	MODEL_UPDATE /COVRPRIOD		MODELSVC -d	SVC	COVRPRIOD		TBD (new attribute)		Always
        ...
        //1.0 
//        Add	CEDS/CHIS	59.00		1	1.0	<MACHRATECATG>	</MACHRATECATG>	2	MODEL_UPDATE /MACHRATECATG			MODEL	MACHRATECATG		Text		Always
//        Add	CEDS/CHIS	59.10		1	1.0	<CECSPRODKEY>	</CECSPRODKEY>	2	MODEL_UPDATE /CECSPRODKEY			MODEL	CECSPRODKEY		Long Description?		Always
//        Add	CEDS/CHIS + ZIPRSX CR	59.20		1	1.0	<PRODSUPRTCD>	</PRODSUPRTCD>	2	MODEL_UPDATE /PRODSUPRTCD			MODEL	PRODSUPRTCD		Text		Always
//        Add	CEDS/CHIS	59.30		1	1.0	<MAINTANNBILLELIGINDC>	</MAINTANNBILLELIGINDC>	2	MODEL_UPDATE /MAINTANNBILLELIGINDC		 	MODEL	MAINTANNBILLELIGINDC		Long Description?		Always
//        Add	CEDS/CHIS	59.40		1	1.0	<NOCHRGMAINTINDC>	</NOCHRGMAINTINDC>	2	MODEL_UPDATE /NOCHRGMAINTINDC		 	MODEL	NOCHRGMAINTINDC		Long Desciption?		Always
//        Add	CEDS/CHIS	59.50		1	1.0	<RETANINDC>	</RETANINDC>	2	MODEL_UPDATE /RETANINDC		 	MODEL	RETANINDC		Short Description?		Always
//        Add	CR 49247	59.60		1	1.0	<SYSTEMTYPE>	</SYSTEMTYPE>	2	MODEL_UPDATE /SYSTEMTYPE		 	MODEL	SYSTEMTYPE		Text	NLSID=1 only	Always
...
//        Add	CR 56561	59.62	1.1		1	1.0	<PHANTOMMODINDC>	</PHANTOMMODINDC>	2	MODEL_UPDATE /PHANTOMMODINDC		 	MODEL	PHANTOMMODINDC		Short Desc	NORM, REACH	Always						
	    XMLMAP.addChild(new XMLElem("PHANTOMMODINDC","PHANTOMMODINDC",XMLElem.SHORTDESC));
//       Add	RCQ246579 - EACM SWMA Indication	59.64	1.1		1	1.0	<SWMAIND>	</SWMAIND>	2	MODEL_UPDATE /SWMAIND		 	MODEL	SWMAIND		Short Desc
        ...
        //1.0	<LENOVOTRNCD>	</LENOVOTRNCD>	2 need to confirm entity and attribute Delete noly for SVCMOD
...
//        langelem.addChild(new XMLElem("MKTGDESC","MODMKTGDESC"));
        ...
        XMLMAP.addChild(list);
        XMLElem elem = new XMLChgSetElem("OSELEMENT");
        list.addChild(elem);
...
//      start of FBLIST structure
        ...
        // level 4
        // need to confirm that the FBACTION is derived from FBACTION or ImageAction?
        ...
        XMLMAP.addChild(list);
        // level 3
        XMLElem cataelem = new XMLNLSElem("CATATTRIBUTEELEMENT");//check for chgs is controlled by XMLGroupElem
        ...
        //XMLElem modbunbundelem = new XMLGroupElem(null,"MODUNBUND","U:MODUNBUND");
...
//        <ACTIVITY>	</ACTIVITY>	3	MODEL_UPDATE /REPLMODELLIST /ACTIVITY			MODEL	ENTITYTYPE		Text
        replmodelelem.addChild(new XMLActivityElem("ACTIVITY"));//TODO should be changed to another value
//        <MODELENTITYTYPE>	</MODELENTITYTYPE>	4	MODEL_UPDATE /REPLMODELLIST /REPLMODELELEMENT /MODELENTITYTYPE			MODEL	ENTITYTYPE		Text
        replmodelelem.addChild(new XMLElem("MODELENTITYTYPE","ENTITYTYPE"));
//        <MODELENTITYID>	</MODELENTITYID>	4	MODEL_UPDATE /REPLMODELLIST /REPLMODELELEMENT /MODELENTITYID			MODEL	ENTITYID		Text
        replmodelelem.addChild(new XMLElem("MODELENTITYID","ENTITYID"));
//        <MACHTYPE>	</MACHTYPE>	4	MODEL_UPDATE /REPLMODELLIST /REPLMODELELEMENT /MACHTYPE			MODEL	MACHTYPEATR		Flag value
        replmodelelem.addChild(new XMLElem("MACHTYPE","MACHTYPEATR"));
//        <MODEL>	</MODEL>	4	MODEL_UPDATE /REPLMODELLIST /REPLMODELELEMENT /MODEL			MODEL	MODELATR		Text
...
//        	</REPLMODELLIST>	2	MODEL_UPDATE /REPLMODELLIST						
    ...
    *
	A.	MQ-Series CID
    */
    public String getMQCID() { return "MODEL_UPDATE"; }
