 ...
 */
public class XLABR5 extends PokBaseABR {

  /**
     * TARGET_NLSID
     *
     */
    public static int TARGET_NLSID = 5;
  ...
  public void execute_run() {
    ...
    try {
      ...
      setDGRptName("XLABR5"); //Set the report name
      printDGSubmitString();
  ...
  public static String getVersion() {
    return ("$Id: XLABR5.java,v 1.19 2010/04/23 15:40:47 lucasrg Exp $");
  }
  /**
