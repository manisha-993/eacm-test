...
//
// $Log: SWMAINTFEATSUPP30APDG.java,v $
...
// add print trace
//
// Revision 1.7  2005/08/04 14:39:43  joan
// fixes
//
// Revision 1.6  2004/11/12 20:44:59  joan
// adjust error messages
//
// Revision 1.5  2004/11/11 19:20:29  joan
// fixes
//
// Revision 1.4  2004/10/05 17:57:44  joan
// fixes
//
// Revision 1.3  2004/09/22 20:25:16  joan
// fixes
//
...
public class SWMAINTFEATSUPP30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMAINTFEATSUPP30APDG.java,v 1.10 2008/09/05 21:25:47 wendy Exp $");
  	}

	public SWMAINTFEATSUPP30APDG(EANMetaFoundation  _mf, SWMAINTFEATSUPP30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMAINTFEATSUPP30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMAINTFEATSUPP30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = " SWMAINTFEATSUPP30APDG checkMissingData method";
		StringBuffer sbReturn = new StringBuffer();
		EntityItem eiBaseCOF =(EntityItem)m_eiList.get("BASE");
		_db.test(eiBaseCOF != null, " Base MODEL is null");
		String strFileName = "PDGtemplates/MaintFeatSupp_30a.txt";
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMAINTFEATSUPP30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTFEATSUPP30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTFEATSUPP30APDG executeAction method";
	//	String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-MaintFeature-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before connecting to supported MODEL.");
		...
		for(int i=0; i < m_afSuppProdVec.size(); i++) {
			...
			if (aeiCOF == null || aeiCOF.length <= 0) {
				m_SBREx.add(" Supported MODELs with classifications Software-OptionalFeature-Base-N/A, MACHTYPE=" + strMachType + ", MODEL=" + strModel + ", OPTFEATUREID=f" + m_strAfOptFeature.substring(1) + " not found.");
			} else {
