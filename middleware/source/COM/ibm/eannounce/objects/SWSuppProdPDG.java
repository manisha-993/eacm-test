...
//
// Revision 1.23  2004/03/12 23:19:13  joan
// changes from 1.2
//
// Revision 1.22  2003/07/15 19:36:55  joan
// move changes from v111
//
// Revision 1.21  2003/07/02 22:55:00  joan
// fix classification
//
// Revision 1.20  2003/07/02 16:10:49  joan
// fix geo
//
// Revision 1.19  2003/06/12 23:08:32  joan
// move changes from v111
//
...
// fix feedback
//
// Revision 1.15  2003/05/13 17:41:51  joan
// fixes for report
//
// Revision 1.14  2003/05/08 17:38:28  joan
// fix fb
//
// Revision 1.13  2003/05/05 21:39:18  joan
// work on xml report
//
// Revision 1.12  2003/04/23 22:32:44  joan
// set profile valon effon
//
// Revision 1.11  2003/04/21 20:43:18  joan
// fb fix
//
...
// adjust code
//
// Revision 1.3  2003/03/27 19:27:41  joan
// fix bugs
//
...
public class SWSuppProdPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSuppProdPDG.java,v 1.25 2008/11/13 18:28:41 wendy Exp $");
  	}

	public SWSuppProdPDG(EANMetaFoundation  _mf, SWSuppProdPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSuppProdPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSuppProdPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSuppProdPDG generateData";
		try {
	...
	//	String strTraceBase = " SWSuppProdPDG executeProduct method";
		...
		String strFileName = "PDGtemplates/SuppProd.txt";
	...
	//	String strTraceBase = " SWSuppProdPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppProdPDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppProdPDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
