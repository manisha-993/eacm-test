...
//
// $Log: SWSuppFeatPDG.java,v $
// Revision 1.26  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.25  2008/09/08 17:32:47  wendy
// Cleanup RSA warnings
//
// Revision 1.24  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.23  2003/07/15 19:36:55  joan
// move changes from v111
//
// Revision 1.22  2003/07/02 22:55:00  joan
// fix classification
//
// Revision 1.21  2003/07/02 16:10:49  joan
// fix geo
//
// Revision 1.20  2003/06/12 23:08:32  joan
// move changes from v111
//
// Revision 1.19  2003/06/11 23:26:23  joan
// move changes
//
// Revision 1.18  2003/06/06 20:20:33  joan
// move changes from v111
//
// Revision 1.17  2003/05/29 00:03:41  joan
// fix feedback
//
// Revision 1.16  2003/05/13 17:41:50  joan
// fixes for report
//
// Revision 1.15  2003/05/08 17:38:28  joan
// fix fb
//
// Revision 1.14  2003/05/05 21:39:18  joan
// work on xml report
//
// Revision 1.13  2003/04/23 22:32:44  joan
// set profile valon effon
//
// Revision 1.12  2003/04/21 20:43:18  joan
// fb fix
//
// Revision 1.11  2003/04/17 16:37:04  joan
// fix code
//
// Revision 1.10  2003/04/14 16:58:14  joan
// fix fb
//
// Revision 1.9  2003/04/10 17:20:01  joan
// fix compile
//
// Revision 1.8  2003/04/10 17:00:42  joan
// fix checking MTM
//
...
public class SWSuppFeatPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSuppFeatPDG.java,v 1.26 2008/11/13 18:28:41 wendy Exp $");
  	}

	public SWSuppFeatPDG(EANMetaFoundation  _mf, SWSuppFeatPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSuppFeatPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSuppFeatPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSuppFeatPDG generateData";
		try {
...
//		String strTraceBase = " SWSuppFeatPDG executeProduct method";
	...
	//	String strTraceBase = " SWSuppFeatPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppFeatPDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppFeatPDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The Software-Support-Base-NA Commercial Offering must be created before any SubscrFeature Commercial Offering.");
