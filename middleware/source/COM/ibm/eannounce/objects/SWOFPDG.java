...
//
// Revision 1.7  2004/03/12 23:19:13  joan
// changes from 1.2
//
...
public class SWOFPDG extends PDGActionItem {
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWOFPDG.java,v 1.9 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWOFPDG(EANMetaFoundation  _mf, SWOFPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWOFPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWOFPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWOFPDG generateData";
		try {
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFPDG executeOptFeature method";
...
*/
	...
	//	String strTraceBase = " SWOFPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFPDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFPDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The SW product must be created before any Optional Features.");
		...
		if (bSearchHIPO) {
			...
			strSai = (String)m_saiList.get("COMMERCIALOF");
