...
//
// Revision 1.26  2004/03/12 23:19:11  joan
// changes from 1.2
//
// Revision 1.25  2003/07/15 19:36:54  joan
// move changes from v111
//
// Revision 1.24  2003/07/02 22:54:59  joan
// fix classification
//
// Revision 1.23  2003/07/02 16:10:48  joan
// fix geo
//
// Revision 1.22  2003/06/12 23:08:31  joan
// move changes from v111
//
// Revision 1.21  2003/06/11 23:26:23  joan
// move changes
//
// Revision 1.20  2003/06/06 20:20:32  joan
// move changes from v111
//
// Revision 1.19  2003/05/29 00:03:40  joan
// fix feedback
//
// Revision 1.18  2003/05/13 17:41:49  joan
// fixes for report
//
// Revision 1.17  2003/05/08 17:38:27  joan
// fix fb
//
// Revision 1.16  2003/05/05 21:39:17  joan
// work on xml report
//
// Revision 1.15  2003/04/23 22:32:43  joan
// set profile valon effon
//
// Revision 1.14  2003/04/21 20:43:17  joan
// fb fix
//
// Revision 1.13  2003/04/16 19:52:45  joan
// fix PDG creating entity
//
// Revision 1.12  2003/04/14 16:58:12  joan
// fix fb
//
// Revision 1.11  2003/04/10 17:20:00  joan
// fix compile
//
// Revision 1.10  2003/04/10 17:00:41  joan
// fix checking MTM
//
// Revision 1.9  2003/04/03 22:39:01  joan
// adjust code
//
// Revision 1.8  2003/04/02 20:57:03  joan
// adjust resetVariable
//
// Revision 1.7  2003/04/01 18:43:32  joan
// add HWFeaturePDG
//
// Revision 1.6  2003/03/28 00:48:09  joan
// adjust code
//
// Revision 1.5  2003/03/27 23:19:50  joan
// fix bugs
//
// Revision 1.4  2003/03/26 22:54:03  joan
// adjust code for optfeature id
//
// Revision 1.3  2003/03/26 20:37:32  joan
// add SW support and maintenance PDGs
//
// Revision 1.2  2003/03/25 18:26:40  joan
// adjust code
//
// Revision 1.1  2003/03/20 21:36:17  joan
// initial load
//
...
public class SWSubsFeatPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EntityItem m_eiBaseCOF = null;
  	/*
  	* Version info
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSubsFeatPDG.java,v 1.28 2008/11/13 18:28:41 wendy Exp $");
  	}


	public SWSubsFeatPDG(EANMetaFoundation  _mf, SWSubsFeatPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSubsFeatPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSubsFeatPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//String strTraceBase = "SWSubsFeatPDG generateData";
		try {
	...
	//	String strTraceBase = " SWSubsFeatPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsFeatPDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsFeatPDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The Software-Subscription-Base-NA Commercial Offering must be created before any SubscrFeature Commercial Offering.");
