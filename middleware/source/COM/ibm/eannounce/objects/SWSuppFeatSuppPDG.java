...
//
// $Log: SWSuppFeatSuppPDG.java,v $
// Revision 1.28  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.27  2008/09/08 17:32:47  wendy
// Cleanup RSA warnings
//
// Revision 1.26  2005/03/11 22:42:54  dave
// removing some auto genned stuff
//
// Revision 1.25  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.24  2003/07/22 17:03:41  joan
...
// move changes from v111
//
// Revision 1.19  2003/06/11 23:26:24  joan
// move changes
//
...
// fix feedback
//
// Revision 1.16  2003/05/13 17:41:49  joan
// fixes for report
//
...
// fb fix
//
// Revision 1.11  2003/04/16 19:52:46  joan
// fix PDG creating entity
//
// Revision 1.10  2003/04/14 16:58:12  joan
// fix fb
//
// Revision 1.9  2003/04/10 17:20:00  joan
// fix compile
//
// Revision 1.8  2003/04/10 17:00:41  joan
// fix checking MTM
//
...
// add HWFeaturePDG
//
// Revision 1.5  2003/03/28 21:35:01  joan
...
public class SWSuppFeatSuppPDG extends PDGActionItem {
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSuppFeatSuppPDG.java,v 1.28 2008/11/13 18:28:41 wendy Exp $");
  	}

	public SWSuppFeatSuppPDG(EANMetaFoundation  _mf, SWSuppFeatSuppPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSuppFeatSuppPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSuppFeatSuppPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSuppFeatSuppPDG generateData";
		try {
...
/*
	...
	//	String strTraceBase = " SWSuppFeatSuppPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppFeatSuppPDG executeAction method";
