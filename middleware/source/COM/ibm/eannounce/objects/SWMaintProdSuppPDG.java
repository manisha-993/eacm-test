...
//
// $Log: SWMaintProdSuppPDG.java,v $
// Revision 1.27  2008/11/13 18:28:40  wendy
// removed unused getGeoVec()
//
// Revision 1.26  2008/09/05 21:25:48  wendy
// Cleanup RSA warnings
//
// Revision 1.25  2004/03/12 23:19:13  joan
// changes from 1.2
//
// Revision 1.24  2003/07/22 17:03:40  joan
// move changes from v111
//
// Revision 1.23  2003/07/15 19:36:53  joan
// move changes from v111
//
// Revision 1.22  2003/07/02 22:54:58  joan
// fix classification
//
// Revision 1.21  2003/07/02 16:10:46  joan
// fix geo
//
// Revision 1.20  2003/06/12 23:08:30  joan
// move changes from v111
//
// Revision 1.19  2003/06/11 23:26:21  joan
// move changes
//
// Revision 1.18  2003/06/06 20:20:31  joan
// move changes from v111
//
// Revision 1.17  2003/05/29 00:03:39  joan
// fix feedback
//
// Revision 1.16  2003/05/13 17:41:51  joan
// fixes for report
//
// Revision 1.15  2003/05/08 17:38:26  joan
// fix fb
//
// Revision 1.14  2003/05/05 21:39:16  joan
// work on xml report
//
// Revision 1.13  2003/04/23 22:32:42  joan
// set profile valon effon
//
// Revision 1.12  2003/04/21 20:43:16  joan
// fb fix
//
// Revision 1.11  2003/04/16 19:52:44  joan
...
// fix compile
//
// Revision 1.8  2003/04/10 17:00:43  joan
// fix checking MTM
//
// Revision 1.7  2003/04/03 22:39:00  joan
// adjust code
//
// Revision 1.6  2003/04/02 20:57:02  joan
// adjust resetVariable
//
// Revision 1.5  2003/04/01 18:43:31  joan
// add HWFeaturePDG
//
...
public class SWMaintProdSuppPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMaintProdSuppPDG.java,v 1.27 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWMaintProdSuppPDG(EANMetaFoundation  _mf, SWMaintProdSuppPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMaintProdSuppPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMaintProdSuppPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWMaintProdSuppPDG generateData";
		try {
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMaintProdSuppPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMaintProdSuppPDG executeAction method";
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			...
			m_SBREx.add(aeiCOM.length + " existing Base COMMERCIALOF for the same machinetype and model.");
		} else {
