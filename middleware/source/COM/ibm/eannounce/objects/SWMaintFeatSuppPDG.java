...
//
// $Log: SWMaintFeatSuppPDG.java,v $
// Revision 1.28  2008/11/13 18:28:40  wendy
// removed unused getGeoVec()
//
// Revision 1.27  2008/09/05 21:25:47  wendy
...
// fix feedback
//
// Revision 1.17  2003/05/13 17:41:51  joan
// fixes for report
//
...
// work on xml report
//
// Revision 1.14  2003/04/23 22:32:40  joan
// set profile valon effon
//
// Revision 1.13  2003/04/23 15:45:25  joan
// fix bugs
//
...
//
// Revision 1.10  2003/04/14 16:58:11  joan
// fix fb
//
...
public class SWMaintFeatSuppPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMaintFeatSuppPDG.java,v 1.28 2008/11/13 18:28:40 wendy Exp $");
  	}

	public SWMaintFeatSuppPDG(EANMetaFoundation  _mf, SWMaintFeatSuppPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMaintFeatSuppPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMaintFeatSuppPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected void generateData(Database _db, Profile _prof, StringBuffer _sbMissing, String _strSupportProd) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = "SWMaintFeatSuppPDG generateData";
		try {
	...
	//	String strTraceBase = " SWMaintFeatSuppPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMaintFeatSuppPDG executeAction method";
