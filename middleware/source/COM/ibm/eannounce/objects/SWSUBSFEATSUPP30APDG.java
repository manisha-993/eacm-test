...
//
// $Log: SWSUBSFEATSUPP30APDG.java,v $
// Revision 1.12  2008/09/05 21:25:47  wendy
// Cleanup RSA warnings
//
// Revision 1.11  2007/09/06 12:39:00  couto
...
//
// Revision 1.7  2004/11/11 19:20:29  joan
// fixes
//
// Revision 1.6  2004/10/05 17:57:44  joan
// fixes
//
// Revision 1.5  2004/09/22 20:25:16  joan
// fixes
//
...
public class SWSUBSFEATSUPP30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSUBSFEATSUPP30APDG.java,v 1.12 2008/09/05 21:25:47 wendy Exp $");
  	}


	public SWSUBSFEATSUPP30APDG(EANMetaFoundation  _mf, SWSUBSFEATSUPP30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSUBSFEATSUPP30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSUBSFEATSUPP30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = " SWSUBSFEATSUPP30APDG checkMissingData method";
		StringBuffer sbReturn = new StringBuffer();
		EntityItem eiBaseCOF =(EntityItem)m_eiList.get("BASE");
		_db.test(eiBaseCOF != null, " Base MODEL is null");

		String strFileName = "PDGtemplates/SubsFeatSupp_30a.txt";
...
/*	private Vector checkOSLEVELUnique(Vector _v) {
	...
	//	String strTraceBase = " SWSUBSFEATSUPP30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUBSFEATSUPP30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUBSFEATSUPP30APDG executeAction method";
	//	String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-SubscrFeature-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before connecting to supported MODEL.");
