...
//
// $Log: SWSuppProdInitialPDG.java,v $
// Revision 1.28  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.27  2008/09/08 17:32:46  wendy
// Cleanup RSA warnings
//
// Revision 1.26  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.25  2004/02/16 19:25:37  joan
// add more billingtemplates
//
// Revision 1.24  2003/07/15 19:36:55  joan
// move changes from v111
//
// Revision 1.23  2003/07/02 22:55:00  joan
// fix classification
//
// Revision 1.22  2003/07/02 16:10:49  joan
// fix geo
//
// Revision 1.21  2003/06/12 23:08:32  joan
// move changes from v111
//
// Revision 1.20  2003/06/11 23:26:24  joan
// move changes
//
// Revision 1.19  2003/06/06 20:20:33  joan
// move changes from v111
//
// Revision 1.18  2003/05/29 00:03:41  joan
// fix feedback
//
// Revision 1.17  2003/05/13 17:41:52  joan
// fixes for report
//
// Revision 1.16  2003/05/08 17:38:28  joan
// fix fb
//
// Revision 1.15  2003/05/05 21:39:18  joan
// work on xml report
//
// Revision 1.14  2003/04/23 22:32:44  joan
// set profile valon effon
//
// Revision 1.13  2003/04/21 20:43:18  joan
// fb fix
//
// Revision 1.12  2003/04/16 19:52:46  joan
// fix PDG creating entity
//
// Revision 1.11  2003/04/14 16:58:12  joan
// fix fb
//
// Revision 1.10  2003/04/10 17:20:00  joan
// fix compile
//
// Revision 1.9  2003/04/10 17:00:41  joan
// fix checking MTM
//
// Revision 1.8  2003/04/10 15:50:05  joan
// adjust code
//
// Revision 1.7  2003/04/02 20:57:04  joan
// adjust resetVariable
//
// Revision 1.6  2003/04/01 18:43:33  joan
// add HWFeaturePDG
//
// Revision 1.5  2003/03/28 01:05:20  joan
// fix bug
//
// Revision 1.4  2003/03/28 00:48:10  joan
// adjust code
//
// Revision 1.3  2003/03/27 23:19:51  joan
// fix bugs
//
// Revision 1.2  2003/03/26 22:54:04  joan
...
public class SWSuppProdInitialPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSuppProdInitialPDG.java,v 1.28 2008/11/13 18:28:41 wendy Exp $");
  	}


	public SWSuppProdInitialPDG(EANMetaFoundation  _mf, SWSuppProdInitialPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSuppProdInitialPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSuppProdInitialPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSuppProdInitialPDG generateData";
		try {
	...
	//	String strTraceBase = " SWSuppProdInitialPDG executeProduct method";
...
/*
	...
	//	String strTraceBase = " SWSuppProdInitialPDG checkPDGAttribute method";
	...
	//						index = f;
			...
			if (att.getKey().equals("AFSWSUPPREQUESTTYPE")) {
				...
				m_SBREx = m_utility.checkOptFeatureIDFormat(textAtt, PDGUtility.OF_SUPPORT, true, m_SBREx);
		...
		if ( ! m_strAfReqType.equals("Support Product")) {
			SBRException ex = new SBRException();
			ex.add(" Request Type:" + m_strAfReqType + ". This action item is for SW Support Product Request.");
			throw ex;
		}
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppProdInitialPDG executeAction method";
