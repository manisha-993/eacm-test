...
//
// $Log: SWMAINTPROD30APDG.java,v $
// Revision 1.8  2008/09/05 21:25:46  wendy
// Cleanup RSA warnings
//
// Revision 1.7  2007/09/06 12:48:27  couto
// MN32841099 WGMODEL replaced by WGMODELA
//
// Revision 1.6  2006/05/08 21:25:14  joan
// add print trace
//
// Revision 1.5  2005/08/04 14:39:43  joan
// fixes
//
// Revision 1.4  2004/10/07 21:55:06  joan
// fixes
//
...
public class SWMAINTPROD30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMAINTPROD30APDG.java,v 1.8 2008/09/05 21:25:46 wendy Exp $");
  	}

	public SWMAINTPROD30APDG(EANMetaFoundation  _mf, SWMAINTPROD30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMAINTPROD30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMAINTPROD30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = " SWMAINTPROD30APDG checkMissingData method";
		...
		String strFileName = "PDGtemplates/MaintProd_30a.txt";
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMAINTPROD30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTPROD30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTPROD30APDG executeAction method";
		//String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
