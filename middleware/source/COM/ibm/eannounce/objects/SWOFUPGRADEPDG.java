...
public class SWOFUPGRADEPDG extends PDGActionItem {
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWOFUPGRADEPDG.java,v 1.11 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWOFUPGRADEPDG(EANMetaFoundation  _mf, SWOFUPGRADEPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWOFUPGRADEPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWOFUPGRADEPDG:" + getKey() + ":desc:" + getLongDescription());
...
//							attList.put(foundEI.getEntityType() + ":PROJCODETAG", "PROJCODETAG=" + m_utility.getAttrValue(m_eiOFPROJ, "PROJCODE"));
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWOFUPGRADEPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFUPGRADEPDG executeAction method";
