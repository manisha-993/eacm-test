...
//
// Revision 1.10  2007/08/27 15:58:04  wendy
...
// fixes
//
// Revision 1.7  2005/03/11 21:54:59  dave
// more jtest cleanup
//
 ...
 */
public class SWSUPPPROD30APDG extends PDGActionItem {
    ...
    */
    ...
    public String getVersion() {
        return "$Id: SWSUPPPROD30APDG.java,v 1.12 2008/09/08 17:32:46 wendy Exp $";
    }
     ...
     *  @author David Bigelow
     */
    public SWSUPPPROD30APDG(EANMetaFoundation _mf, SWSUPPPROD30APDG _ai) throws MiddlewareRequestException {
        super(_mf, _ai);
    }
     ...
     *  @author David Bigelow
     */
    public SWSUPPPROD30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
    ...
    public String dump(boolean _bBrief) {
        ...
        strbResult.append("SWSUPPPROD30APDG:" + getKey() + ":desc:" + getLongDescription());
    ...
    protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
        ...
        if (aeiCOM.length > 0) {
        	...
        	_db.debug(D.EBUG_SPEW, "SWSUPPPROD30APDG.checkMissingData search "+strSai+" found "+m_eiBaseCOF.getKey());
        }else{
        	_db.debug(D.EBUG_SPEW, "SWSUPPPROD30APDG.checkMissingData search "+strSai+" found nothing");
		}

        String strFileName = "PDGtemplates/SuppProd_30a.txt";
    ...
    public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
        String strTraceBase = " SWSUPPPROD30APDG viewMissing method";
    ...
    public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
        String strTraceBase = " SWSUPPPROD30APDG executeAction method";
       // String strData = "";
        try {
            _db.debug(D.EBUG_DETAIL, strTraceBase);
            m_SBREx = new SBRException();
