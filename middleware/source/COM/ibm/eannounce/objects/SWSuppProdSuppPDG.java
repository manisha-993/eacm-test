...
//
// $Log: SWSuppProdSuppPDG.java,v $
// Revision 1.25  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.24  2008/09/08 17:32:47  wendy
// Cleanup RSA warnings
//
// Revision 1.23  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.22  2003/07/22 17:03:41  joan
// move changes from v111
//
// Revision 1.21  2003/07/15 19:36:55  joan
// move changes from v111
//
// Revision 1.20  2003/07/02 22:55:00  joan
// fix classification
//
// Revision 1.19  2003/07/02 16:10:49  joan
// fix geo
//
// Revision 1.18  2003/06/11 23:26:24  joan
// move changes
//
// Revision 1.17  2003/06/06 20:20:34  joan
// move changes from v111
//
// Revision 1.16  2003/05/29 00:03:41  joan
// fix feedback
//
// Revision 1.15  2003/05/13 17:41:52  joan
// fixes for report
//
// Revision 1.14  2003/05/08 17:38:28  joan
// fix fb
//
// Revision 1.13  2003/05/05 21:39:19  joan
// work on xml report
//
// Revision 1.12  2003/04/23 22:32:44  joan
// set profile valon effon
//
// Revision 1.11  2003/04/21 20:43:19  joan
// fb fix
//
// Revision 1.10  2003/04/16 19:52:46  joan
// fix PDG creating entity
//
// Revision 1.9  2003/04/14 16:58:14  joan
// fix fb
//
// Revision 1.8  2003/04/10 17:20:02  joan
// fix compile
//
// Revision 1.7  2003/04/10 17:00:43  joan
// fix checking MTM
//
// Revision 1.6  2003/04/02 20:57:05  joan
// adjust resetVariable
//
// Revision 1.5  2003/04/01 18:43:34  joan
// add HWFeaturePDG
//
...
public class SWSuppProdSuppPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSuppProdSuppPDG.java,v 1.25 2008/11/13 18:28:41 wendy Exp $");
  	}


	public SWSuppProdSuppPDG(EANMetaFoundation  _mf, SWSuppProdSuppPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSuppProdSuppPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSuppProdSuppPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSuppProdSuppPDG generateData";
		try {
...
//		String strTraceBase = " SWSuppProdSuppPDG executeProduct method";
	...
	//	String strTraceBase = " SWSuppProdSuppPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSuppProdSuppPDG executeAction method";
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		for(int i=0; i < m_afSuppProdVec.size(); i++) {
			...
			sb1.append("map_COFSUBCAT=214;");
			sb1.append("map_COFGRP=300;");
			sb1.append("map_COFSUBGRP=405;");
