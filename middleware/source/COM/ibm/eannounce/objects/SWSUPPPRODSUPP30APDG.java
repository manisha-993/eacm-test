...
//
// $Log: SWSUPPPRODSUPP30APDG.java,v $
// Revision 1.10  2008/09/08 17:32:46  wendy
// Cleanup RSA warnings
//
// Revision 1.9  2007/09/06 12:57:16  couto
...
// fixes
//
// Revision 1.5  2004/09/03 15:58:03  joan
// fixes
//
// Revision 1.4  2004/09/02 17:04:55  joan
// fixes
//
// Revision 1.3  2004/09/02 16:57:01  joan
// fixes
//
// Revision 1.2  2004/09/02 16:25:38  joan
// fixes
//
...
public class SWSUPPPRODSUPP30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSUPPPRODSUPP30APDG.java,v 1.10 2008/09/08 17:32:46 wendy Exp $");
  	}


	public SWSUPPPRODSUPP30APDG(EANMetaFoundation  _mf, SWSUPPPRODSUPP30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSUPPPRODSUPP30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSUPPPRODSUPP30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = " SWSUPPPRODSUPP30APDG checkMissingData method";
		StringBuffer sbReturn = new StringBuffer();
		EntityItem eiBaseCOF =(EntityItem)m_eiList.get("BASE");
		_db.test(eiBaseCOF != null, " Base MODEL is null");
		String strFileName = "PDGtemplates/SuppProdSupp_30a.txt";
...
/*	private Vector checkOSLEVELUnique(Vector _v) {
	...
	//	String strTraceBase = " SWSUPPPRODSUPP30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUPPPRODSUPP30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUPPPRODSUPP30APDG executeAction method";
	//	String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-Support-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before connecting to supported MODEL.");
		} else if (aeiCOM.length > 1) {
			m_SBREx.add(aeiCOM.length + " existing MODEL with classifications SW-Support-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature);
		} else {
		...
		for(int i=0; i < m_afSuppProdVec.size(); i++) {
			...
			if (aeiCOF == null || aeiCOF.length <= 0) {
				m_SBREx.add(" Supported Software-Application-Base-N/A MODELs for " + strSuppProd + " not found.");
			} else {
