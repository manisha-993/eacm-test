...
//
// $Log: SWMaintProdInitialPDG.java,v $
// Revision 1.28  2008/11/13 18:28:40  wendy
// removed unused getGeoVec()
//
// Revision 1.27  2008/09/05 21:25:46  wendy
// Cleanup RSA warnings
//
// Revision 1.26  2004/03/12 23:19:13  joan
// changes from 1.2
//
...
// move changes
//
// Revision 1.19  2003/06/06 20:20:31  joan
// move changes from v111
//
// Revision 1.18  2003/05/29 00:03:38  joan
// fix feedback
//
// Revision 1.17  2003/05/13 17:41:53  joan
// fixes for report
//
// Revision 1.16  2003/05/08 17:38:25  joan
// fix fb
//
// Revision 1.15  2003/05/05 21:39:16  joan
// work on xml report
//
...
// fb fix
//
// Revision 1.12  2003/04/16 19:52:44  joan
// fix PDG creating entity
//
// Revision 1.11  2003/04/14 16:58:11  joan
// fix fb
//
...
// fix checking MTM
//
// Revision 1.8  2003/04/10 15:50:06  joan
// adjust code
//
...
public class SWMaintProdInitialPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMaintProdInitialPDG.java,v 1.28 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWMaintProdInitialPDG(EANMetaFoundation  _mf, SWMaintProdInitialPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMaintProdInitialPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMaintProdInitialPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected void generateData(Database _db, Profile _prof, StringBuffer _sbMissing, String _strSearchKey) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = "SWMaintProdInitialPDG generateData";
		try {
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = " SWMaintProdInitialPDG executeProduct method";
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMaintProdInitialPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMaintProdInitialPDG executeAction method";
