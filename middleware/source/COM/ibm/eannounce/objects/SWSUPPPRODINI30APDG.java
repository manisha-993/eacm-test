...
//
// $Log: SWSUPPPRODINI30APDG.java,v $
// Revision 1.12  2008/09/08 17:32:47  wendy
// Cleanup RSA warnings
//
// Revision 1.11  2007/09/06 12:54:16  couto
// Prevent requesttype null pointer.
//
// Revision 1.10  2007/08/27 18:35:21  wendy
...
public class SWSUPPPRODINI30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return "$Id: SWSUPPPRODINI30APDG.java,v 1.12 2008/09/08 17:32:47 wendy Exp $";
  	}


	public SWSUPPPRODINI30APDG(EANMetaFoundation  _mf, SWSUPPPRODINI30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSUPPPRODINI30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSUPPPRODINI30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = " SWSUPPPRODINI30APDG checkMissingData method";
	...
	//	String strTraceBase = " SWSUPPPRODINI30APDG checkPDGAttribute method";
	...
	//		int index = -1;
		...
		if ( ! "Support Product".equals(m_strAfReqType)) {
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUPPPRODINI30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUPPPRODINI30APDG executeAction method";
		//String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-Support-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before Initial MODEL.");
		} else if (aeiCOM.length > 1) {
			m_SBREx.add("There are " + aeiCOM.length + " existing MODELs with classifications SW-Support-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature);
		} else {
