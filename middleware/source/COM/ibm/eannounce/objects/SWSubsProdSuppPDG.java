...
//
// $Log: SWSubsProdSuppPDG.java,v $
// Revision 1.27  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.26  2008/09/08 17:32:46  wendy
...
//
// Revision 1.23  2003/07/15 19:36:54  joan
// move changes from v111
//
// Revision 1.22  2003/07/02 22:55:00  joan
// fix classification
//
// Revision 1.21  2003/07/02 16:10:48  joan
// fix geo
//
...
public class SWSubsProdSuppPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSubsProdSuppPDG.java,v 1.27 2008/11/13 18:28:41 wendy Exp $");
  	}


	public SWSubsProdSuppPDG(EANMetaFoundation  _mf, SWSubsProdSuppPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSubsProdSuppPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSubsProdSuppPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSubsProdSuppPDG generateData";
		try {
...
//		String strTraceBase = " SWSubsProdSuppPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsProdSuppPDG executeAction method";
