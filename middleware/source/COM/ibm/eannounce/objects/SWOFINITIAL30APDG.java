...
//
// $Log: SWOFINITIAL30APDG.java,v $
// Revision 1.18  2008/09/05 21:25:48  wendy
// Cleanup RSA warnings
//
// Revision 1.17  2007/09/06 12:23:54  couto
// MN32841099 WGMODEL replaced by WGMODELA
//
// Revision 1.16  2006/05/16 00:08:11  joan
// changes
//
// Revision 1.15  2006/05/15 16:10:38  joan
// changes
//
// Revision 1.14  2006/05/08 21:25:14  joan
// add print trace
//
// Revision 1.13  2005/02/17 21:14:01  joan
// fixes
//
// Revision 1.12  2005/02/17 16:58:05  joan
// work on CR
//
// Revision 1.11  2005/01/13 00:40:57  joan
// fixes for null billing template
//
// Revision 1.10  2005/01/10 18:55:29  joan
// fixes
//
// Revision 1.9  2005/01/10 18:32:20  joan
// fixes
//
// Revision 1.8  2004/11/12 20:44:59  joan
// adjust error messages
//
// Revision 1.7  2004/10/21 20:19:01  joan
// add catch MiddlewareRequest
//
// Revision 1.6  2004/10/11 22:10:31  joan
// fixes
//
// Revision 1.5  2004/10/05 16:05:02  joan
// fixes
//
// Revision 1.4  2004/09/03 20:20:13  joan
// fixes
//
// Revision 1.3  2004/09/03 18:14:06  joan
// fixes
//
...
public class SWOFINITIAL30APDG extends PDGActionItem {
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWOFINITIAL30APDG.java,v 1.18 2008/09/05 21:25:48 wendy Exp $");
  	}


	public SWOFINITIAL30APDG(EANMetaFoundation  _mf, SWOFINITIAL30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWOFINITIAL30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWOFINITIAL30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected void generateDataII(Database _db, Profile _prof, StringBuffer _sbMissing, String _strSearchKey) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = "SWOFINITIAL30APDG generateDataII";
		try {
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFINITIAL30APDG checkMissingData method";
		...
		if (m_strAfBillingTemplate.equals("IPLA06")) {
			strFileName = "PDGtemplates/OptFeatureBTIPLA06_2_30a.txt";
			if (m_strAfCreateMES != null && m_strAfCreateMES.equals("Yes")) {
				strFileName = "PDGtemplates/OptFeatureBTIPLA06_1_30a.txt";
			}
		} else if (m_strAfBillingTemplate.equals("IPLA22")) {
			strFileName = "PDGtemplates/OptFeatureBTIPLA22_30a.txt";
		} else if (m_strAfBillingTemplate.equals("IPLA25")) {
			strFileName = "PDGtemplates/OptFeatureBTIPLA25_30a.txt";
		} else if (m_strAfBillingTemplate.equals("NOBILLING")) {
			return sbReturn;
		} else {
			strFileName = "PDGtemplates/OptFeatureBT_30a.txt";
		}
...
/*	private Vector checkOSLEVELUnique(Vector _v) {
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWOFINITIAL30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFINITIAL30APDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWOFINITIAL30APDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			if (!runBySPDG()) {
				m_SBREx.add("The MODEL with clasifications SW-OptionalFeature-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before Initial Commercial Offering.");
			}
