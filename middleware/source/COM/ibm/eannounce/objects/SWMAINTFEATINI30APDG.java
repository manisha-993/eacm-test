...
//
// $Log: SWMAINTFEATINI30APDG.java,v $
// Revision 1.12  2008/09/05 21:25:46  wendy
// Cleanup RSA warnings
//
// Revision 1.11  2007/09/06 12:48:27  couto
// MN32841099 WGMODEL replaced by WGMODELA
//
// Revision 1.10  2006/05/08 21:25:14  joan
// add print trace
//
// Revision 1.9  2005/08/10 17:58:07  joan
// fixes
//
// Revision 1.8  2005/08/04 14:39:43  joan
// fixes
//
// Revision 1.7  2005/02/18 19:04:21  joan
// fixes
//
// Revision 1.6  2005/02/18 18:54:50  joan
// fixes
//
...
public class SWMAINTFEATINI30APDG extends PDGActionItem {
...
//	private	Vector m_afGeoVec = new Vector();
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMAINTFEATINI30APDG.java,v 1.12 2008/09/05 21:25:46 wendy Exp $");
  	}


	public SWMAINTFEATINI30APDG(EANMetaFoundation  _mf, SWMAINTFEATINI30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMAINTFEATINI30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMAINTFEATINI30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = " SWMAINTFEATINI30APDG checkMissingData method";
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMAINTFEATINI30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTFEATINI30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTFEATINI30APDG executeAction method";
		//String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiAPPCOM.length <= 0 ) {
			...
			m_SBREx.add("There are " + aeiAPPCOM.length + " existing MODELs with classifications Software-Maintenance-Base-NA, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel);
		} else {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-MaintFeature-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel + ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before Initial MODEL.");
		} else if (aeiCOM.length > 1) {
			m_SBREx.add("There are " + aeiCOM.length + " existing MODEL with classifications SW-MaintFeature-Base, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel + ", OPTFEATUREID=" + m_strAfOptFeature);
		} else {
