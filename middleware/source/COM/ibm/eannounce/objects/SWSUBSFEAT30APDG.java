...
//
// $Log: SWSUBSFEAT30APDG.java,v $
// Revision 1.10  2008/09/05 21:25:47  wendy
// Cleanup RSA warnings
//
// Revision 1.9  2007/09/06 12:39:00  couto
// MN32841099 WGMODEL replaced by WGMODELA
//
// Revision 1.8  2006/05/08 21:25:15  joan
// add print trace
//
// Revision 1.7  2005/08/04 14:39:26  joan
// fixes
//
...
public class SWSUBSFEAT30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EntityItem m_eiBaseCOF = null;
  	...
  	*/
  	public String getVersion() {
  		return "$Id: SWSUBSFEAT30APDG.java,v 1.10 2008/09/05 21:25:47 wendy Exp $";
  	}
	public SWSUBSFEAT30APDG(EANMetaFoundation  _mf, SWSUBSFEAT30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSUBSFEAT30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSUBSFEAT30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = " SWSUBSFEAT30APDG checkMissingData method";
		StringBuffer sbReturn = new StringBuffer();

		EntityItem eiBaseCOF = (EntityItem)m_eiList.get("BASE");
		_db.test(eiBaseCOF != null, " Base MODEL is null");

		String strFileName = "PDGtemplates/SubsFeat_30a.txt";
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWSUBSFEAT30APDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUBSFEAT30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSUBSFEAT30APDG executeAction method";
		//String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications Software-Subscription-Base-NA, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel + " must be created before any SubscrFeature MODEL.");
		} else if (aeiCOM.length > 1) {
			m_SBREx.add("There are " + aeiCOM.length + " existing MODELs with classifications Software-Subscription-Base-NA, MACHTYPE=" + m_strAfMachType + ", MODEL=" + m_strAfModel);
		} else {
