...
//
// $Log: SWMaintFeatInitialPDG.java,v $
// Revision 1.29  2008/11/13 18:28:40  wendy
// removed unused getGeoVec()
//
// Revision 1.28  2008/09/05 21:25:48  wendy
// Cleanup RSA warnings
//
// Revision 1.27  2004/03/12 23:19:13  joan
// changes from 1.2
//
// Revision 1.26  2004/02/16 19:25:37  joan
// add more billingtemplates
//
// Revision 1.25  2003/07/15 19:36:52  joan
// move changes from v111
//
// Revision 1.24  2003/07/02 22:54:57  joan
// fix classification
//
// Revision 1.23  2003/07/02 16:10:46  joan
// fix geo
//
// Revision 1.22  2003/06/12 23:08:29  joan
// move changes from v111
//
// Revision 1.21  2003/06/11 23:26:21  joan
// move changes
//
// Revision 1.20  2003/06/06 20:20:30  joan
// move changes from v111
//
// Revision 1.19  2003/05/29 00:03:38  joan
// fix feedback
//
// Revision 1.18  2003/05/13 17:41:49  joan
// fixes for report
//
// Revision 1.17  2003/05/08 17:38:25  joan
// fix fb
//
// Revision 1.16  2003/05/05 21:39:15  joan
// work on xml report
//
// Revision 1.15  2003/04/23 22:32:41  joan
// set profile valon effon
//
// Revision 1.14  2003/04/21 20:43:15  joan
// fb fix
//
// Revision 1.13  2003/04/16 19:52:43  joan
// fix PDG creating entity
//
// Revision 1.12  2003/04/14 16:58:13  joan
// fix fb
//
// Revision 1.11  2003/04/10 17:20:01  joan
// fix compile
//
// Revision 1.10  2003/04/10 17:00:42  joan
// fix checking MTM
//
// Revision 1.9  2003/04/10 15:50:06  joan
// adjust code
//
...
// add HWFeaturePDG
//
// Revision 1.5  2003/03/29 01:11:41  joan
// fix throw ex
//
// Revision 1.4  2003/03/28 00:48:07  joan
// adjust code
//
// Revision 1.3  2003/03/27 23:19:49  joan
// fix bugs
//
...
public class SWMaintFeatInitialPDG extends PDGActionItem {
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMaintFeatInitialPDG.java,v 1.29 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWMaintFeatInitialPDG(EANMetaFoundation  _mf, SWMaintFeatInitialPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMaintFeatInitialPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMaintFeatInitialPDG:" + getKey() + ":desc:" + getLongDescription());
...
//		String strTraceBase = "SWMaintFeatInitialPDG generateData";
		try {
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = " SWMaintFeatInitialPDG checkMissingData method";
...
//		String strTraceBase = " SWMaintFeatInitialPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMaintFeatInitialPDG executeAction method";
