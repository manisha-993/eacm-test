...
//
// $Log: SWSubsProdInitialPDG.java,v $
// Revision 1.33  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.32  2008/09/05 21:25:47  wendy
// Cleanup RSA warnings
//
// Revision 1.31  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.30  2004/02/16 19:25:37  joan
// add more billingtemplates
//
// Revision 1.29  2003/09/22 17:36:11  joan
// add IASP108V2
//
// Revision 1.28  2003/07/15 19:36:54  joan
// move changes from v111
//
// Revision 1.27  2003/07/02 22:54:59  joan
// fix classification
//
// Revision 1.26  2003/07/02 16:10:48  joan
// fix geo
//
// Revision 1.25  2003/06/12 23:08:31  joan
// move changes from v111
//
// Revision 1.24  2003/06/11 23:26:23  joan
// move changes
//
// Revision 1.23  2003/06/06 20:20:33  joan
// move changes from v111
//
// Revision 1.22  2003/05/29 00:03:40  joan
// fix feedback
//
// Revision 1.21  2003/05/13 17:41:49  joan
// fixes for report
//
// Revision 1.20  2003/05/09 23:52:20  joan
// fix report
//
// Revision 1.19  2003/05/08 17:38:27  joan
// fix fb
//
// Revision 1.18  2003/05/05 21:39:17  joan
// work on xml report
//
// Revision 1.17  2003/04/23 22:32:43  joan
// set profile valon effon
//
// Revision 1.16  2003/04/21 20:43:17  joan
// fb fix
//
// Revision 1.15  2003/04/16 19:52:45  joan
// fix PDG creating entity
//
// Revision 1.14  2003/04/14 16:58:13  joan
// fix fb
//
// Revision 1.13  2003/04/10 17:20:02  joan
// fix compile
//
// Revision 1.12  2003/04/10 17:00:43  joan
// fix checking MTM
//
// Revision 1.11  2003/04/10 15:50:06  joan
// adjust code
//
// Revision 1.10  2003/04/03 22:39:02  joan
// adjust code
//
// Revision 1.9  2003/04/02 20:57:03  joan
// adjust resetVariable
//
// Revision 1.8  2003/04/01 18:43:32  joan
// add HWFeaturePDG
//
// Revision 1.7  2003/03/28 00:48:09  joan
// adjust code
//
// Revision 1.6  2003/03/27 23:19:51  joan
// fix bugs
//
// Revision 1.5  2003/03/26 22:54:03  joan
// adjust code for optfeature id
//
// Revision 1.4  2003/03/26 20:37:32  joan
// add SW support and maintenance PDGs
//
// Revision 1.3  2003/03/25 17:09:20  joan
// fix bug
//
// Revision 1.2  2003/03/25 00:19:46  joan
// some adjustments
//
...
public class SWSubsProdInitialPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return "$Id: SWSubsProdInitialPDG.java,v 1.33 2008/11/13 18:28:41 wendy Exp $";
  	}

	public SWSubsProdInitialPDG(EANMetaFoundation  _mf, SWSubsProdInitialPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSubsProdInitialPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSubsProdInitialPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected void generateData(Database _db, Profile _prof, StringBuffer _sbMissing, String _strSearchKey) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = "SWSubsProdInitialPDG generateData";
		try {
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		//String strTraceBase = " SWSubsProdInitialPDG executeProduct method";
		...
		for(int i=0; i < m_afRegTypeVec.size(); i++) {
			...
			String strFileName = "PDGtemplates/SubsProdInitial.txt";
			if (strRegType.equals("Grp2Grp")) {			// Grp2Grp
				if (! m_strAfBillingTemplate.equals("NOBILLING")) {
					strFileName = "PDGtemplates/SubsProdInitial_2.txt";
				}
				...
				if (m_strAfBillingTemplate.equals("IASP003") || m_strAfBillingTemplate.equals("IASP141") || m_strAfBillingTemplate.equals("IASP108V2")) {
					strFileName = "PDGtemplates/SubsProdInitial_1.txt";
				} else if (m_strAfBillingTemplate.equals("IASP096") || m_strAfBillingTemplate.equals("IASP098")) {
					strFileName = "PDGtemplates/SubsProdInitial_3.txt";
				} else if (m_strAfBillingTemplate.equals("IASP147")) {
					strFileName = "PDGtemplates/SubsProdInitial_4.txt";
				}
			}
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWSubsProdInitialPDG checkAFIRMAttribute method";
		...
		if ( ! m_strAfReqType.equals("Subscription Product")) {
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsProdInitialPDG executeAction method";
