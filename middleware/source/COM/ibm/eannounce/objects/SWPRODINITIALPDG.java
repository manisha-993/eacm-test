...
public class SWPRODINITIALPDG extends PDGActionItem {
    ...
    //private String m_strAfMktName = null;
    ...
    */
    public String getVersion() {
        return new String("$Id: SWPRODINITIALPDG.java,v 1.8 2008/09/05 21:25:46 wendy Exp $");
    }


    public SWPRODINITIALPDG(EANMetaFoundation  _mf, SWPRODINITIALPDG _ai) throws MiddlewareRequestException {
        super(_mf, _ai);
    }

    public SWPRODINITIALPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
        super(_emf, _db,  _prof, _strActionItemKey);
    }

    public String dump(boolean _bBrief) {
        StringBuffer strbResult = new StringBuffer();
        strbResult.append("SWPRODINITIALPDG:" + getKey() + ":desc:" + getLongDescription());
  ...
  //      String strTraceBase = " SWPRODINITIALPDG executeProduct method";
        StringBuffer sbReturn = new StringBuffer();
        EntityItem eiBaseCOF = (EntityItem)m_eiList.get("BASE");

        String strFileName = "";
        if (m_strAfBillingTemplate.equals("IPLA06")) {
            strFileName = "PDGtemplates/BillingTemplateIPLA06_2.txt";
            if (m_strAfCreateMES != null && m_strAfCreateMES.equals("Yes")) {
                strFileName = "PDGtemplates/BillingTemplateIPLA06_1.txt";
            }
        } else if (m_strAfBillingTemplate.equals("IPLA22")) {
            strFileName = "PDGtemplates/BillingTemplateIPLA22.txt";
        } else if (m_strAfBillingTemplate.equals("IPLA25")) {
            strFileName = "PDGtemplates/BillingTemplateIPLA25.txt";
        } else if (m_strAfBillingTemplate.equals("NOBILLING")) {
			return sbReturn;
		} else {
			strFileName = "PDGtemplates/BillingTemplate.txt";
		}
    ...
    private Vector getGeoVec(Vector _geoVec) {
    ...
    protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
       // String strTraceBase = " SWPRODINITIALPDG checkPDGAttribute method";
        for (int i =0; i < _afirmEI.getAttributeCount(); i++) {
         ...
         //   String sFlagClass = "";
           ...
           // int index = -1;
            ...
            } else if (att.getKey().equals("MKTGNAME")) {
                //m_strAfMktName = textAtt;
    ...
    public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
        String strTraceBase = " SWPRODINITIALPDG viewMissingData method";
    ...
    public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
        String strTraceBase = " SWPRODINITIALPDG executeAction method";
        m_SBREx = new SBRException();
		resetVariables();
		String strData = "";
		try {
