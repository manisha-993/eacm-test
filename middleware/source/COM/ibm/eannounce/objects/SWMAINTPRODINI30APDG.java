...
//
// $Log: SWMAINTPRODINI30APDG.java,v $
// Revision 1.11  2008/09/05 21:25:47  wendy
// Cleanup RSA warnings
//
// Revision 1.10  2007/09/27 13:32:52  wendy
// MNfix4Deanna billingtemplate IASP103 should work like IASP096
//
...
// add print trace
//
// Revision 1.7  2005/08/10 17:58:07  joan
// fixes
//
// Revision 1.6  2005/08/04 14:39:43  joan
// fixes
//
// Revision 1.5  2005/01/13 00:40:57  joan
// fixes for null billing template
//
// Revision 1.4  2004/11/12 20:44:59  joan
// adjust error messages
//
// Revision 1.3  2004/10/05 17:57:44  joan
// fixes
//
// Revision 1.2  2004/09/03 15:58:01  joan
// fixes
//
// Revision 1.1  2004/09/01 18:27:21  joan
// add files
//
//
...
public class SWMAINTPRODINI30APDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	//private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWMAINTPRODINI30APDG.java,v 1.11 2008/09/05 21:25:47 wendy Exp $");
  	}


	public SWMAINTPRODINI30APDG(EANMetaFoundation  _mf, SWMAINTPRODINI30APDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWMAINTPRODINI30APDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWMAINTPRODINI30APDG:" + getKey() + ":desc:" + getLongDescription());
	...
	protected StringBuffer checkMissingData(Database _db, Profile _prof, boolean _bGenData) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTPRODINI30APDG checkMissingData method";
		...
		for(int i=0; i < m_afRegTypeVec.size(); i++) {
			...
			String strFileName = "PDGtemplates/MaintProdInitial_30a.txt";
			// default template => find MODEL| create MODELREL |find AVAIL;linkParent;create MODELAVAIL
			if (strRegType.equals("Grp2Grp")) {			// if Grp2Grp
				if (! m_strAfBillingTemplate.equals("NOBILLING")) {
					strFileName = "PDGtemplates/MaintProdInitial_4_30a.txt";
				}
			} else {
				if (m_strAfBillingTemplate.equals("IASP003") || m_strAfBillingTemplate.equals("IASP141") || m_strAfBillingTemplate.equals("IASP108V")) {
					strFileName = "PDGtemplates/MaintProdInitial_3_30a.txt";
				} else if (m_strAfBillingTemplate.equals("IASP096") ||m_strAfBillingTemplate.equals("IASP098")) {
					strFileName = "PDGtemplates/MaintProdInitial_1_30a.txt";
				} else if (m_strAfBillingTemplate.equals("IASP147")) {
					strFileName = "PDGtemplates/MaintProdInitial_2_30a.txt";
				} else if (m_strAfBillingTemplate.equals("IASP103")) { // MNfix4Deanna
					strFileName = "PDGtemplates/MaintProdInitial_103_30a.txt"; // start as dupe of MaintProdInitial_1_30a.txt
				}
			}
			_db.debug(D.EBUG_SPEW, strTraceBase+" template: "+strFileName+" regtype: "+strRegType+
				" billingtemplate: "+m_strAfBillingTemplate);
			...
			_db.debug(D.EBUG_SPEW, strTraceBase+" sbMissing: "+sbMissing);
...
/*
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWMAINTPRODINI30APDG checkPDGAttribute method";
		...
		if ( ! "Maintenance Product".equals(m_strAfReqType)) {
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTPRODINI30APDG viewMissing method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWMAINTPRODINI30APDG executeAction method";
		//String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
 ...
 */
	...
	protected void checkDataAvailability(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		if (aeiCOM.length <= 0 ) {
			m_SBREx.add("The MODEL with classifications SW-Maintenance-Base, MACHTYPE=" + m_strAfMachType + ", MODELATR=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature + " must be created before Initial MODEL.");
		} else if (aeiCOM.length > 1) {
			m_SBREx.add("There are " + aeiCOM.length + " existing MODELs with classifications SW-Maintenance-Base, MACHTYPE=" + m_strAfMachType + ", MODELATR=" + m_strAfModel+ ", OPTFEATUREID=" + m_strAfOptFeature);
		} else {
				   	...
				   	if (amf[f].isSelected()) {
				    	String sFlagAtt = amf[f].getLongDescription().trim();
				       	if (!sFlagAtt.equals(m_strAfBillingTemplate)) {
							m_SBREx.add(" Billing Template on the request must match Billing Template on the Base MODEL " + sFlagAtt+" "+aeiCOM[0].getKey());
						}
				       	break;
				   	}
			    }
