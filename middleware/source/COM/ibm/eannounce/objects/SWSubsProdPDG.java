...
//
// $Log: SWSubsProdPDG.java,v $
// Revision 1.25  2008/11/13 18:28:41  wendy
// removed unused getGeoVec()
//
// Revision 1.24  2008/09/08 17:32:46  wendy
// Cleanup RSA warnings
//
// Revision 1.23  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.22  2003/07/15 19:36:54  joan
// move changes from v111
//
// Revision 1.21  2003/07/02 22:54:59  joan
// fix classification
//
// Revision 1.20  2003/07/02 16:10:48  joan
// fix geo
//
...
// fixes for report
//
// Revision 1.15  2003/05/08 17:38:27  joan
// fix fb
//
// Revision 1.14  2003/05/05 21:39:17  joan
// work on xml report
//
// Revision 1.13  2003/04/23 22:32:43  joan
...
// fix checking MTM
//
// Revision 1.7  2003/04/03 22:39:02  joan
// adjust code
//
// Revision 1.6  2003/04/02 20:57:04  joan
// adjust resetVariable
//
// Revision 1.5  2003/04/01 18:43:33  joan
// add HWFeaturePDG
//
...
//
// Revision 1.2  2003/03/26 20:37:33  joan
...
public class SWSubsProdPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSubsProdPDG.java,v 1.25 2008/11/13 18:28:41 wendy Exp $");
  	}


	public SWSubsProdPDG(EANMetaFoundation  _mf, SWSubsProdPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSubsProdPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSubsProdPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSubsProdPDG generateData";
		try {
	...
	//	String strTraceBase = " SWSubsProdPDG executeProduct method";
		...
		String strFileName = "PDGtemplates/SubsProd.txt";
	...
	//	String strTraceBase = " SWSubsProdPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		...
		String strTraceBase = " SWSubsProdPDG viewMissingData method";
	...
	public void executeAction(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsProdPDG executeAction method";
		String strData = "";
		try {
			_db.debug(D.EBUG_DETAIL, strTraceBase);
			m_SBREx = new SBRException();
