...
//
// $Log: SWSubsFeatInitialPDG.java,v $
// Revision 1.32  2008/11/13 18:28:40  wendy
// removed unused getGeoVec()
//
// Revision 1.31  2008/09/05 21:25:46  wendy
// Cleanup RSA warnings
//
// Revision 1.30  2004/03/12 23:19:12  joan
// changes from 1.2
//
// Revision 1.29  2004/02/16 19:25:37  joan
// add more billingtemplates
//
// Revision 1.28  2003/09/22 17:36:11  joan
// add IASP108V2
//
// Revision 1.27  2003/07/15 19:36:54  joan
// move changes from v111
//
// Revision 1.26  2003/07/02 22:54:59  joan
// fix classification
//
// Revision 1.25  2003/07/02 16:10:48  joan
// fix geo
//
// Revision 1.24  2003/06/12 23:08:31  joan
// move changes from v111
//
// Revision 1.23  2003/06/11 23:26:22  joan
// move changes
//
// Revision 1.22  2003/06/06 20:20:32  joan
// move changes from v111
//
// Revision 1.21  2003/05/29 00:03:40  joan
// fix feedback
//
// Revision 1.20  2003/05/13 17:41:50  joan
// fixes for report
//
...
//
// Revision 1.14  2003/04/14 16:58:11  joan
// fix fb
//
// Revision 1.13  2003/04/10 17:20:00  joan
// fix compile
//
// Revision 1.12  2003/04/10 17:00:41  joan
// fix checking MTM
//
// Revision 1.11  2003/04/10 15:50:06  joan
// adjust code
//
// Revision 1.10  2003/04/03 22:39:01  joan
// adjust code
//
...
// add HWFeaturePDG
//
// Revision 1.7  2003/03/29 01:11:41  joan
// fix throw ex
//
// Revision 1.6  2003/03/28 00:48:08  joan
// adjust code
//
// Revision 1.5  2003/03/27 23:19:50  joan
// fix bugs
//
// Revision 1.4  2003/03/26 22:54:02  joan
// adjust code for optfeature id
//
// Revision 1.3  2003/03/26 20:37:32  joan
...
public class SWSubsFeatInitialPDG extends PDGActionItem {
  ...
  static final long serialVersionUID = 20011106L;
	...
	private EANList m_opList = new EANList();
  	...
  	*/
  	public String getVersion() {
  		return new String("$Id: SWSubsFeatInitialPDG.java,v 1.32 2008/11/13 18:28:40 wendy Exp $");
  	}


	public SWSubsFeatInitialPDG(EANMetaFoundation  _mf, SWSubsFeatInitialPDG _ai) throws MiddlewareRequestException {
		super(_mf, _ai);
	}

	public SWSubsFeatInitialPDG(EANMetaFoundation _emf, Database _db, Profile _prof, String _strActionItemKey) throws SQLException, MiddlewareException, MiddlewareRequestException {
	  	super(_emf, _db,  _prof, _strActionItemKey);
	}

  	public String dump(boolean _bBrief) {
   		StringBuffer strbResult = new StringBuffer();
   		strbResult.append("SWSubsFeatInitialPDG:" + getKey() + ":desc:" + getLongDescription());
	...
	//	String strTraceBase = "SWSubsFeatInitialPDG generateData";
		try {
...
//		String strTraceBase = " SWSubsFeatInitialPDG checkMissingData method";
		...
		for(int i=0; i < m_afRegTypeVec.size(); i++) {
			...
			String strFileName = "PDGtemplates/SubsFeatInitial.txt";
			if (strRegType.equals("Grp2Grp")) {			// Grp2Grp
				if (! m_strAfBillingTemplate.equals("NOBILLING")) {
					strFileName = "PDGtemplates/SubsFeatInitial_2.txt";
				}
				...
				if (m_strAfBillingTemplate.equals("IASP003") || m_strAfBillingTemplate.equals("IASP108V2") || m_strAfBillingTemplate.equals("IASP141")) {
					strFileName = "PDGtemplates/SubsFeatInitial_1.txt";
				} else if (m_strAfBillingTemplate.equals("IASP096") || m_strAfBillingTemplate.equals("IASP098")) {
					strFileName = "PDGtemplates/SubsFeatInitial_3.txt";
				} else if (m_strAfBillingTemplate.equals("IASP147")) {
					strFileName = "PDGtemplates/SubsFeatInitial_4.txt";
				}
			}
	...
	protected void checkPDGAttribute(Database _db, Profile _prof, EntityItem _afirmEI) throws SQLException, MiddlewareRequestException, MiddlewareException, SBRException, MiddlewareShutdownInProgressException {
		//String strTraceBase = " SWSubsFeatInitialPDG checkPDGAttribute method";
	...
	public byte[] viewMissing(Database _db, Profile _prof) throws SQLException, MiddlewareException, MiddlewareShutdownInProgressException, SBRException {
		String strTraceBase = " SWSubsFeatInitialPDG executeAction method";
