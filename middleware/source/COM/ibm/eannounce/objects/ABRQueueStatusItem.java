...
*
*/
//$Log: ABRQueueStatusItem.java,v $
//Revision 1.1  2013/09/19 15:06:57  wendy
//add abr queue status
//
public class ABRQueueStatusItem extends EANFoundation implements EANAddressable {
	 ...
	 */	
	public ABRQueueStatusItem(EANFoundation _f, Profile _prof, String _key, Hashtable colsTbl)
			throws MiddlewareRequestException {
		super(_f, _prof, _key);
