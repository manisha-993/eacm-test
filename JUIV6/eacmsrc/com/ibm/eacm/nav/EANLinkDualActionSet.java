...
/*******
 *
 * used for the collection of Navigate linkdual actions, it will be used with a button and menu
 * @author Wendy Stimpson
 */
// $Log: EANLinkDualActionSet.java,v $
// Revision 1.1  2012/09/27 19:39:14  wendy
// Initial code
//
public class EANLinkDualActionSet extends EANActionSet {
	 ...
	 *
	 */
	public EANLinkDualActionSet(Navigate n){
		super(NAVLINKD_ACTIONSET,KeyEvent.VK_L, Event.CTRL_MASK);
	    putValue(Action.LARGE_ICON_KEY, Utils.getImageIcon("linkD.gif"));
	    parent = n;
	}
