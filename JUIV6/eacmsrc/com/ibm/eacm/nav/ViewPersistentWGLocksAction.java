...
/*********************************************************************
 * This is used for view WG persistent locks request
 * @author Wendy Stimpson
 */
//$Log: ViewPersistentWGLocksAction.java,v $
...
//Initial code
//
public class ViewPersistentWGLocksAction extends EACMAction
{
	private static final long serialVersionUID = 1L;
	private NavController parent=null;
	public ViewPersistentWGLocksAction(NavController n) {
		super(VIEWPW_ACTION,KeyEvent.VK_9, Event.CTRL_MASK + Event.ALT_MASK);
		putValue(Action.LARGE_ICON_KEY, Utils.getImageIcon("lockWGPanel.gif"));
		parent = n;
	}
	...
	public void actionPerformed(ActionEvent e) {
		if (!EACM.getEACM().viewLockExist(true)) { //if it exists, that tab is selected
			...
			SwingUtilities.invokeLater(new Runnable() {
				public void run() {
					...
					if(prof !=null){
						try {
							LockActionTab lat = new LockActionTab(true, prof);
