...
/*********************************************************************
 * This is used to delete a column of relators in CrossTable
 * @author Wendy Stimpson
 */
//$Log: DeleteColAction.java,v $
...
//Initial code
//
public class DeleteColAction extends EACMAction implements FocusListener
{
	...
	public DeleteColAction(CrossTable _tab,MatrixActionBase mab) {
		super(MTRX_DELETECOL,KeyEvent.VK_DELETE, Event.ALT_MASK,true);
		putValue(Action.LARGE_ICON_KEY, Utils.getImageIcon("0col.gif"));
		setTable(_tab);
		actionTab = mab;
	}
