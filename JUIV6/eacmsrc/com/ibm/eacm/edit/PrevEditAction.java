...
/*************
* 
* this action is used for prev arrow button in RecordToggle for vertical editor and form editor
* @author Wendy Stimpson	
*/
//$Log: PrevEditAction.java,v $
//Revision 1.1  2012/09/27 19:39:19  wendy
//Initial code
//
public class PrevEditAction extends EACMAction 
{
	 ...
	 * @param ec
	 */
	public PrevEditAction(EditController ec) {
		super(PREVEDIT_ACTION,KeyEvent.VK_P, Event.CTRL_MASK + Event.SHIFT_MASK);
	...
	protected boolean canEnable(){ 
		...
		if(ok){
			ok = editCtrl.getRecordToggle().getViewRowCount()>1 && editCtrl.getRecordToggle().getCurrentIndex()>0;
		}
		return ok;
	}
	/* (non-Javadoc)
