...
/*********************************************************************
* This is used to save the selected record as default
* @author Wendy Stimpson
*/
//$Log: SaveDefaultAction.java,v $
//Revision 1.1  2012/09/27 19:39:19  wendy
//Initial code
//
public class SaveDefaultAction extends EACMAction implements PropertyChangeListener
{
	 ...
	 * @param ed
	 */
	public SaveDefaultAction(EditController ed) {
		super(SAVEDEFAULT_ACTION,KeyEvent.VK_S, Event.CTRL_MASK + Event.ALT_MASK);
		putValue(Action.LARGE_ICON_KEY, Utils.getImageIcon("defSave.gif"));
		editCtrl = ed;
	...
	private class SaveWorker extends HeavyWorker<Exception, Void> { 
		...
		public Exception doInBackground() {
			try{
				...
				ei.updateWGDefault(null, RMIMgr.getRmiMgr().getRemoteDatabaseInterface()); 
			}catch(Exception x){
				return x;
			}finally{
