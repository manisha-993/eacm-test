...
public class XMLDTD extends DTD
{
    ...
    private static Vector<String> dtdVct = null;
...
*/
                    Vector<Element> elemVec = new Vector<Element>(1);
                    Vector<Element> baseElemVec = new Vector<Element>(1);
                    Vector<Element> badContentVct = new Vector<Element>(1);
...
//" value: "+alist.value+" values: "+alist.values);
    ...
    {
        private Hashtable<String, String> parmEntityTbl = new Hashtable<String, String>();
        ...
        {
            Vector<String> badElems = new Vector<String>(1);
...
System.out.println("element from vec "+ee);
    ...
    */
            ...
            // look at the elements this dtd has built
            outterloop:for (Enumeration<String> e = elementHash.keys(); e.hasMoreElements();)
            {
                Element elem = null;
                String key = (String)e.nextElement();
                ...
                // inner loop
                for (Enumeration<String> e2 = elementHash.keys(); e2.hasMoreElements();)
                {
