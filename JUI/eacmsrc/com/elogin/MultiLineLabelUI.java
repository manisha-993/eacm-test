 ...
 * This is the initial load of OPICM
 *
 * Revision 1.4  2003/11/03 16:04:10  tony
 * 52847
 *
 * Revision 1.3  2003/10/07 21:36:21  tony
...
public class MultiLineLabelUI extends BasicLabelUI {
    ...
    protected String layoutCL(JLabel label, FontMetrics fontMetrics, String text, Icon icon, Rectangle viewR, Rectangle iconR, Rectangle textR) {
        String s =
            layoutCompoundLabel(
                label,
                fontMetrics,
                Routines.splitStringByLines(text),
                icon,
    ...
    public static String layoutCompoundLabel(
        ...
        textIsEmpty = (text == null) || (text.length == 0) || (text.length == 1 && ((text[0] == null) || text[0].equals("")));
    ...
    protected void drawString(Graphics g, String s, int accChar, int textX, int textY) {
        if (s.indexOf('\n') == -1) {
            ...
            if (strs != null) { //52847
                ...
                int l = strs.length;
                //52847				BasicGraphicsUtils.drawString(g, getString(strs[0]), accChar, textX, textY);
                String strDraw = getString(strs[0]); //52847
                if (strDraw != null) { //52847
                    BasicGraphicsUtils.drawString(g, strDraw, accChar, textX, textY); //52847
                } //52847
                for (int i = 1; i < l; i++) {
                    strDraw = getString(strs[i]); //52847
                    if (strDraw != null) { //52847
                        g.drawString(strDraw, textX, textY + (height * i)); //52847
                        //52847					g.drawString(getString(strs[i]), textX, textY + (height*i));
                    } //52847
                }
            } //52847
        }
    ...
    public static Dimension computeMultiLineDimension(FontMetrics fm, String[] strs) {
        ...
        return new Dimension(width, fm.getHeight() * l);
    }
