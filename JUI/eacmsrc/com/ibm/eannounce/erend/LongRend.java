 ...
 * This is the initial load of OPICM
 *
 * Revision 1.9  2003/10/03 16:39:14  tony
 * updated accessibility.
 *
 * Revision 1.8  2003/06/17 20:45:14  tony
 * updated logic to use underline instead of empty border
 *
 * Revision 1.7  2003/04/28 16:44:08  tony
 * adjusted rendering of vertical table.
 *
 * Revision 1.6  2003/04/23 17:15:52  tony
 * cleaned-up code
 *
 ...
 * @author Anthony C. Liberto
 */
public class LongRend extends EMLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        setText((value == null) ? "" : Routines.splitString(value.toString(), 80));
