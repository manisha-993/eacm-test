 ...
 *
 * $Log: LockedSingleRenderer.java,v $
 ...
 *
 * Revision 1.3  2003/03/13 23:58:51  tony
 ...
 * This is the initial load of OPICM
 *
 * Revision 1.1.1.1  2001/11/29 19:00:23  tony
 * This is the initial load of OPICM
 *
 * Revision 1.1.1.1  2001/08/06 21:39:14  tony
 * This is the initial load of OPICM
 *
 * Revision 1.1  2001/04/20 20:23:55  tony
 * initial load
 *
 *
 */
 ...
 * @author Anthony C. Liberto
 */
public class LockedSingleRenderer extends ESLabel implements TableCellRenderer, EAccessConstants {
...
//    private Border noFocusBorder = UIManager.getBorder("eannounce.underlineBorder");
    ...
    /**
     * LockedSingleRenderer
     * @author Anthony C. Liberto
     */
    public LockedSingleRenderer() {
        setUseDefined(false);
        return;
    }
