 ...
 * This is the initial load of OPICM
 *
 * Revision 1.9  2003/10/03 16:39:13  tony
 * updated accessibility.
 *
 * Revision 1.8  2003/06/17 20:45:15  tony
 ...
 * @author Anthony C. Liberto
 */
public class ChildRend extends ELabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
		...
		setForeground(getPrefColor(PREF_COLOR_CHILD,DEFAULT_COLOR_CHILD));
		if (hasFocus) {
