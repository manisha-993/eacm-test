 ...
 * This is the initial load of OPICM
 *
 * Revision 1.2  2003/12/16 20:54:47  tony
 * 53418
 *
 * Revision 1.1  2003/12/01 17:42:10  tony
 * accessibility
 *
 * Revision 1.10  2003/10/03 16:39:13  tony
 * updated accessibility.
 *
 * Revision 1.9  2003/06/17 20:45:15  tony
 * updated logic to use underline instead of empty border
 *
 * Revision 1.8  2003/04/24 22:22:50  tony
 * updated rendering
 *
 * Revision 1.7  2003/04/24 21:49:54  tony
 * updated rendering.
 *
...
import com.elogin.*;
import com.ibm.eannounce.eobjects.ECheckBox;
import java.awt.*;
import javax.swing.*;
 ...
 * @author Anthony C. Liberto
 */
public class BooRend extends ECheckBox implements TableCellRenderer {
    ...
    public BooRend() {
		...
		setOpaque(true);
		setUseDefined(false);
		setHorizontalAlignment(SwingConstants.CENTER);		//53418
		setVerticalAlignment(SwingConstants.CENTER);		//53418
		return;
	}
