 ...
 * This is the initial load of OPICM
 *
 * Revision 1.6  2003/10/03 16:39:14  tony
 * updated accessibility.
 *
 * Revision 1.5  2003/05/01 22:41:37  tony
 ...
 * @author Anthony C. Liberto
 */
public class LockedBooleanRend extends JCheckBox implements TableCellRenderer, EAccessConstants {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
    	...
    	if (isSelected) {
            setForeground(getPrefColor(PREF_COLOR_LOCK,DEFAULT_COLOR_LOCK));
