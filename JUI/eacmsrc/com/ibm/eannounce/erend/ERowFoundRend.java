 ...
 * @author Anthony C. Liberto
 */
public class ERowFoundRend extends ELabel implements TableCellRenderer, EAccessConstants {
	private static final long serialVersionUID = 1L;
	/**
     * eRowFoundRend
     * @author Anthony C. Liberto
     */
    public ERowFoundRend() {
		setBackground(getPrefColor(PREF_COLOR_FOUND,DEFAULT_COLOR_FOUND));
