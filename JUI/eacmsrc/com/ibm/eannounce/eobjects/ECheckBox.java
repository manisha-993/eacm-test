 ...
 *
 * $Log: ECheckBox.java,v $
 * Revision 1.3  2012/04/05 17:38:58  wendy
 ...
 *
 * Revision 1.4  2005/01/28 19:36:58  tony
 * JTest Second Pass
 *
 ...
 *
 * Revision 1.11  2003/10/07 21:34:33  tony
 ...
 * @author Anthony C. Liberto
 */
public class ECheckBox extends JCheckBox implements EAccessConstants, EDisplayable {
     ...
     * @author Anthony C. Liberto
     */
    public ECheckBox (String s,Icon i) {
		super(s,i);
		init();
		return;
	}
     ...
     * @author Anthony C. Liberto
     */
    public ECheckBox (String s, boolean b) {
		super(s,b);
		init();
		return;
     ...
     * @author Anthony C. Liberto
     */
    public ECheckBox (Icon i, boolean b) {
		super(i,b);
		init();
		return;
	}
     ...
     * @author Anthony C. Liberto
     */
    public ECheckBox (String s, Icon i, boolean b) {
		super(s,i,b);
		init();
		return;
	}
