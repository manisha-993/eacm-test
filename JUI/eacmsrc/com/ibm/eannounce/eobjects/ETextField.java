 ...
 *
 * $Log: ETextField.java,v $
 * Revision 1.3  2012/04/05 17:46:43  wendy
 ...
 * This is the initial load of OPICM
 *
 * Revision 1.15  2003/10/29 19:10:43  tony
 * acl_20031029
 *
 * Revision 1.14  2003/10/27 22:18:21  tony
 ...
 * @author Anthony C. Liberto
 */
public class ETextField extends JTextField implements EAccessConstants, EDisplayable {
     ...
     * @author Anthony C. Liberto
     */
    public ETextField(String _txt, int _cols) {
        super(_txt, _cols);
        return;
    }
     ...
     * @author Anthony C. Liberto
     */
    public ETextField(Document _doc, String _txt, int _cols) {
        super(_doc, _txt, _cols);
        return;
    }
