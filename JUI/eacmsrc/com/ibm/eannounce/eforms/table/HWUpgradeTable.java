 ...
 * This is the initial load of OPICM
 *
 * Revision 1.3  2004/01/05 17:00:51  tony
 * acl_20040104
 * updated logic to prevent null pointer on close tab.
 *
 * Revision 1.2  2003/10/24 21:11:29  tony
 * 52719
 *
 * Revision 1.1.1.1  2003/03/03 18:03:50  tony
 * This is the initial load of OPICM
 *
 * Revision 1.2  2002/10/30 17:51:50  joan
 * add LockedBooleanRenderer
 *
 * Revision 1.1  2002/10/18 23:53:58  joan
 * add code for HWUPGRADEActionItem
 *
 ...
 */
public class HWUpgradeTable extends GTable implements KeyListener, MouseMotionListener {
	private static final long serialVersionUID = 1L;
    private HWUpgradeTableModel cgtm = null;
    private HWUpgradeList m_hwul = null;
    /**
     * textCol
     */
     ...
     * @author Anthony C. Liberto
     */
    public HWUpgradeTable(HWUpgradeList _hwul, RowSelectableTable _rst) {
        super();
        cgtm = new HWUpgradeTableModel(_hwul, _rst);
        m_rst = _rst;
        m_hwul = _hwul;
        setModel(cgtm);
        init();
     ...
     * @author Anthony C. Liberto
     */
    public void refreshTable(HWUpgradeList _hwul) {
        cgtm = new HWUpgradeTableModel(_hwul, _hwul.getTable());
        setModel(cgtm);
        resizeCells();
        cgtm.modelChanged();
        return;
     ...
     * @author Anthony C. Liberto
     */
    public HWUpgradeList getHWUpgradeList() {
        return m_hwul;
    }
    ...
    public ERowList refreshList() {
        ...
        m_rList.setHeaderValue("HW Upgrade"); //cgtm.getTableTitle());
