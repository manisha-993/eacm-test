 ...
 *	@author Joan Tran
 *
 * $Log: HWUpgradeTableModel.java,v $
 ...
 */
public class HWUpgradeTableModel implements TableModel {
    /**
     * listenerlist
     */
     ...
     * @param _rst
     */
    public HWUpgradeTableModel(HWUpgradeList _hwul, RowSelectableTable _rst) {
        setHWUpgradeList(_hwul);
        setTable(_rst);
        modelChanged();
        return;
    }
    ...
    private void setHWUpgradeList(HWUpgradeList _hwul) {
        m_hwul = _hwul;
    }
     ...
     * @param r
     */
    public Object getValueAt(int _r, int _c, boolean _b) {
        return m_rst.getMatrixValue(_r, _c);
    }
