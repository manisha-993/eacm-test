...
public class XMLWriter extends AbstractWriter implements XMLEditorGlobals
{
    ...
    private Vector formattedVct=null;     // v111
...
//System.err.println("init pos: "+pos+" len "+len);
        ...
        formattedVct = new Vector();
        tags = new Vector(10);
        tagValues = new Vector(10);
        tagsToRemove = new Vector(10);
