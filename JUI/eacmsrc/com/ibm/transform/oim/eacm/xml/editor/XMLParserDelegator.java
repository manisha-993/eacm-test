...
class XMLParserDelegator extends HTMLEditorKit.Parser
{
    ...
    static final Vector IGNORED_ELEM_VCT;
    private static final Hashtable ENTITY_DEF_TBL;
    static {
